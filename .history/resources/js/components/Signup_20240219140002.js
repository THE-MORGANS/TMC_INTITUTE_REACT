                    ...
                    <div class="col-xxl-7 col-xl-8 align-self-end">
                      <div class="woocommerce-form-login-toggle">
                            <div class="woocommerce-info">
                                Sign up? <a onClick={(e)=>handleClick(e)} data-name="login" class="showlogin cursor">Click here to login</a>
                            </div>
                        </div>
                        ...
                        <form action="mail.php" method="POST" class="consult-form ajax-contact">
                            <div class="row gx-24">
                                ...
                                <div class="form-group">
                                    {showbtn == false?
                                        <button class=" cursor-pointer info-btn" disabled onClick={(e)=>handleSubmit(e)}>
