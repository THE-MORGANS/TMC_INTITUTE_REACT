                    ...
                    <div class="col-xxl-7 col-xl-8 align-self-end">
                        <form action="mail.php" method="POST" class="consult-form ajax-contact">
                            <div class="row gx-24">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                      <input type={changepass == false?"password":"text"}    class="form-control" onChange={(e)=>Setpasssword(e.target.value)} value={pasword} />
            
                                        <input type="tel" class="form-control" name="number" id="number" class="form-control"/>
