                      ...
                      <div class="woocommerce-form-login-toggle">
                        ...
                        <form action="mail.php" method="POST" class="consult-form ajax-contact">
                            <div class="row gx-24">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                    <input type={conpass == false?"password":"text"}  placeholder="ComfirnPassword" class="form-control" onChange={(e)=>Setpassword_confirmation(e.target.value)} value={password_confirmation} />
