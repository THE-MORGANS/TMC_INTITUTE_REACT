                            ...
                            <div class="row gx-24">
                                ...
                                <div className='col-md-12'>
                                  <div class="form-group">
                                    <img src={captimg} />
                                    <br/>
                                    <input type="text" className="form-control" onChange={(e)=>Setcaptcha(e.target.value)} value={captcha} autoComplete="off" />

                                    <input placeholder="Enter Recaprcha value" type="text" class="form-control" onChange={(e)=>Setcaptcha(e.target.value)} value={captcha} autoComplete="off" />
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    :
                                    <button class="th-btn cursor-pointer col-12" onClick={(e)=>handleSubmit(e)}>
                                    {loader?'please wait...':'Sign up'}
                                    </button>
                                    }
