        ...
        <footer className="footer footer_type_1">
            ...
            <div className="row row-cols-lg-5 row-cols-2">
                ...
                <ul className="sub-menu__list list-unstyled">
                    <li className="sub-menu__item"><a href="#" claclassNamess="menu-link menu-link_us-s">Cooperate governance</a></li>
                    <li className="sub-menu__item"><a href="#" class="menu-link menu-link_us-s">Financial crime prevention</a></li>
