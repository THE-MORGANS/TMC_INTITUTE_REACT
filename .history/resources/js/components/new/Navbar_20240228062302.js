                                                    ...
                                                    <li class="menu-item-has-children">
                                                        ...
                                                        <li>
                                                            ...
                                                            <li>
                                                                ...
                                                                <div className='row' style={{ color:'#333'}}>
                                                                    <div className='col-3'>
                                                                        <img src="https://snatikabucket.s3.ap-southeast-1.amazonaws.com/uploads/manage-cms/universities-image/651bc96eba4c2_universities_image" alt="Image" class="img-responsive"/>
                                                                     </div>
                                                                    <div className='col-9' style={{marginLeft: '-20px', marginTop:'-5px'}}>
                                                                        <snap style={{frontWeight:'500'}}>Strategic Management and Leadership (MBA)</snap>
                                                                    </div>
                                                                </div>
                                                                <a href="#">Course 2</a>
                                                                {/* <a href="#">
