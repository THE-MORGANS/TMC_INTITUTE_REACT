                        ...
                        <div className="row justify-content-between">
                            ...
                            <div className="col-md-6 col-xl-auto">
                                <div className="widget widget_nav_menu footer-widget">
                                    <h3 className="widget_title">Cs</h3>
                                    <div className="menu-all-pages-container">
                                        <ul className="menu">
                                            <li><a href="">Cooperate governance</a></li>
                                            <li><a href="c.html">Financial crime prevention</a></li>
                                            <li><a href="c.html">Insurance cs</a></li>
                                            <li><a href="c.html">Development</a></li>
                                            <li><a href="c.html">Risk management</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
