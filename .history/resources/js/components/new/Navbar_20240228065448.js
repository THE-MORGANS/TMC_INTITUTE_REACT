                                                            ...
                                                            <li>
                                                                <a href=''>
                                                                    <div className='row' style={{ color:'#333'}}>
                                                                        <div className='col-2'>
                                                                            <img width={120} height={30} src="https://snatikabucket.s3.ap-southeast-1.amazonaws.com/uploads/manage-cms/universities-image/651bc9b74c6d5_universities_image" alt="Image" class="img-responsive"/>
                                                                        </div>
                                                                ...
                                                                <a href=''>
                                                                    <div className='row' style={{ color:'#333'}}>
                                                                        <div className='col-2'>
                                                                            <img width={120} height={30} src="https://snatikabucket.s3.ap-southeast-1.amazonaws.com/uploads/manage-cms/universities-image/651bc8d942e76_universities_image" alt="Image" class="img-responsive"/>
                                                                        </div>
                                                                        <div className='col-10' style={{marginLeft: '-20px', marginTop:'-5px'}}>
