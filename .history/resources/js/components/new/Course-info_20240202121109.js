                                    ...
                                    {video.map((item, index) => (
                                        <div class="checklist mb-1">
                                             <ul>
                                                    ...
                                                    {usercourse ? (
                                                    <>
                                                        <li  key={index}></li> <BsFillPlayFill /> {item.courseepisodetitle}{' '}
                                                        <li  key={index}></li> <AiFillLock /> {item.courseepisodetitle}{' '}
                                                        <span className="text-sm ml-auto">{item.courseduration}</span>
                                                    </>
                                                    ) : (
                                                    <>
                                                        <span className="text-sm ml-auto">{item.courseduration}</span>
