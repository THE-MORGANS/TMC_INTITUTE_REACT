                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 form-group">
                                    <input type="text" class="form-control" placeholder="Full Name" value={username}/>
                                </div>
                                <div class="col-md-6 form-group">
                                    <input disabled type="text" class="form-control" placeholder="Last Name" value= {additional === null?"no data":additional.nameprint}/>
                                </div>
                                <div class="col-12 form-group">
