              ...
              <div className="p-4">
                <div className="row mb-5">
                  ...
                  <div className="col-lg-6  justify-content-between">
                    <div className="mb-1 pb-4 mb-xl-5 pb-xl-5"></div>
                    <h2 style=" font-weight:900; color:#37226C" className="section-title text-left mb-4 mb-xl-5">
                      Stydy Abroad Part
                    </h2>
                    ...
                    <div className="text-left mt-2">
                      <a href="#" className="btn btn-primary js-open-aside mb-xl-4 " style=" border-radius: 10px;" >Career Information</a>
                    </div>
                  </div>
                </div>
              </div>
