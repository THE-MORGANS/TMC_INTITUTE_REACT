                                                    ...
                                                    <li class="menu-item-has-children">
                                                        ...
                                                        <li>
                                                            ...
                                                            <li>
                                                                ...
                                                                <div className='row' >
                                                                    <div className='col-4'>
                                                                        <img width={1000} height={30} src="https://snatikabucket.s3.ap-southeast-1.amazonaws.com/uploads/manage-cms/universities-image/655ae8ea0e3cf_universities_image" alt="Image" class="img-responsive"/>                                                                      
                                                                    </div>
                                                                    <div className='col-8' >
