                ...
                <div className="container">
                    <div className="header-desk header-desk_type_1">
                                ...
                                <li className="navigation__item">
                                    ...
                                    <div className="box-menu" style={{ width: '600px' }}>
                                        ...
                                        <div className="col pe-4">
                                            ...
                                            <ul className="sub-menu__list list-unstyled">
                                                <li className="sub-menu__item"><a onClick={(e)=>handleAboutus(e)} className="menu-link menu-link_us-s">LGCA</a></li>
                                                <li className="sub-menu__item"><a onClick={(e)=>handleAboutus(e)} className="menu-link menu-link_us-s">OTHM</a></li>
                        ...
                        <div className="header-tools d-flex align-items-center">
                            <a href="/cart" className="header-tools__item header-tools__cart" data-aside="cartDrawer">
