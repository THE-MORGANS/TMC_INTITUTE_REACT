                ...
                <form action="#" class="woocommerce-checkout mt-40">
                    ...
                    <div class="form-row place-order">
                      ...
                      :
                          ...
                          sm:py-3 sm:w-60 sm:px-2 sm:rounded-md sm:text-sm sm:text-white  md:bg-[#A32926] md:py-3 md:w-60 md:px-2 md:rounded-md md:text-sm md:text-white lg:bg-[#A32926] lg:py-3 lg:px-2 lg:rounded-md lg:text-sm lg:text-white' onClick={handleback}>
                          Back Home
                          </button>
                      }
