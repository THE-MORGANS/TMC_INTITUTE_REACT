...
export default function Course_info() {
    ...
    const [data2, Setdata2] = useState(allcourse.length > 0?allcourse:[]);
                ...
                <div className="col-xxl-9 col-lg-8">
                    <div className="course-single">
                        <div className="course-single-top">
                            ...
                            <ul className="course-single-meta d-flex justify-content-between ">
                                <li><span className="meta-title">Category: </span><a href="course.html">{single.coursename}</a></li>
                                <li><center></center><span className="meta-title">Last Update: </span><a href="course.html">{convertDate(single.created_at)}</a></li>
                                <li>
