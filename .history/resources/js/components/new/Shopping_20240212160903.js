  ...
  return (
    <div>
      ...
      <div className="th-cart-wrapper space-top space-extra-bottom">
                        ...
                        <div className="row justify-content-end">
                            <div className="col-md-8 col-lg-7 col-xl-6">
                                ...
                                <PayPalScriptProvider options={{ "client-id": "AUBDz8zhTjw7acKU1_wB6b-ngtUEEsYD2vPbPtr6i8Lp5zHlvvgq-zhdpUBSuFNZ5qMlvaNB2SI23M5A" }}>
                                    <PayPalButtons style={{layout:'vertical', z_index:'-5'}}
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div  class="woocommerce-form-login">
                                ...
                                <div class="form-group">
                                {edit?
                                <button type="submit" class="th-btn" onClick={(e)=>handleEditarr(e)}>Edit</button>
                                <button className="px-4 py-3 capitalize bg-blue-700 text-white" onClick={(e)=>handleEditarr(e)}>Edit</button>:
        ...
        <article className="bg-cover top-0 left-0 right-0 bottom-0 bg-black bg-opacity-10 fixed z-10 flex flex-row justify-center overflow-y-scroll py-4">
