                                            ...
                                            <div class="checklist mb-1">
                                                ...
                                                <li className="hover:bg-gray-100  mb-3 flex rounded-md items-center" key={index}>
                                                        ...
                                                        <div className="d-flex">
                                                            ...
                                                            <img src={single.picture} style={{ width: '50px', height: '50px', borderRadius:'10px' }} alt="video" />
                                                            <a href={item.courselink} className="play-btn popup-video">
                                                                <i className="fas fa-play" style={{ width: '50px', height: '50px', borderRadius:'10px' }} ></i>
                                                            </a>
                                                            </div>
                                                        </div>
