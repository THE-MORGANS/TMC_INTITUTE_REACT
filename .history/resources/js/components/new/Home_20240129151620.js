...
export default function Home()  {
  let url = window.location.origin;
    ...
    const featured = [
      ...
      { id: 1, title: 'Featured Course 1', description: 'Description for Featured Course 1', image_url: 'path/to/image1.jpg' },
      { id: 2, title: 'Featured Course 2', description: 'Description for Featured Course 2', image_url: 'path/to/image2.jpg' },
      // ... more data ...
    ];
