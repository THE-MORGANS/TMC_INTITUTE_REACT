       ...
       <Navbar />
        <main class="bg-grey-faf9f8">
          ...
          <section className="products-carousel container">
            ...
            <section className="contact-us container" style={{backgroundColor:  '#37226C', borderRadius:'20px', padding:'10px'}}>
                ...
                <div className="p-3 text-center">
                  <div className="row mb-5">
                    ...
                    <div className=" col-xl-4">
                      <div className="mb-1 pb-4 mb-xl-5 pb-xl-5"></div>
                      <h2 style=" font-weight:900; color:#fff" className="section-title text-left mb-4 mb-xl-3">
                      ...
                      <div className="text-left mt-2">
                        <form action="" className="footer-newsletter__form position-relative bg-body">
                          <input className="form-control border-white" type="email" name="email" placeholder="Enter your email" style={{background-image: url(&quot;data:image/png;base64,) 
