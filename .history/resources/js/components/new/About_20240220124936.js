                ...
                <div class="row">
                    <div class="col-xl-6 mb-30 mb-xl-0">
                        <div class="cta-box" data-bg-src="assets/img/update1/bg/cta_bg_5.jpg">
                            <h3 class="cta-title">WE COVER THE FULL GRC (GOVERNANCE & RISK COMPLIANCE) SPECTRUM</h3>
                    ...
                    <div class="col-xl-6">
                        <div class="cta-box" data-bg-src="assets/img/update1/bg/cta_bg_6.jpg">
                            ...
                            <p class="cta-text">Completely predominate impactful products for 
                            front-end data. Distinctively reinvent high payoff value whereas one-to-one mindshare. Seamlessly exploit extensibl
                            e content after market-driven.</p>
                            <a href="contact.html" class="th-btn">
                                Apply Now<i class="fas fa-arrow-right ms-2"></i>
                            </a>
                        </div>
