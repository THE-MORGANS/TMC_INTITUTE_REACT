                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 form-group">
                                    ...
                                    <input disabled type="text" class="form-control" placeholder="Certificate" value= {additional === null?"no data":additional.nameprint}/>
                                </div>
                                <div class="col-12 form-group">
                                    <label> Name to be printed on the Certificate *</label>
                                    <input type="text" class="form-control" placeholder="Your Company Name" value={additional === null?"no data":additional.gender} />
                                </div>
                                <div class="col-12 form-group">
