        ...
        <div className="">
            ...
            <div className="breadcumb-wrapper" data-bg-src="assets/img/bg/breadcumb-bg.jpg" data-overlay="title" data-opacity="8">
                ...
                <div className="container">
                    ...
                    <h1 className="breadcumb-title">Mission Us</h1>
            ...
            <div className="overflow-hidden overflow-hidden bg-smoke space" id="Mission-sec" data-bg-src="assets/img/bg/Mission-5-bg.png">
                <div className="container">
                    ...
                    <div className="col-xl-6 mb-50 mb-xl-0">
                        ...
                        <div className="img1">
                            <img className="tilt-active" src="assets/img/normal/Mission_5_1.png" alt="Mission" />
                        </div>
                        ...
                        <div className="img2">
                            <img className="tilt-active" src="assets/img/normal/Mission_5_2.png" alt="Mission" />
                        </div>
                    ...
                    <div className="col-xl-6">
                        ...
                        <span className="sub-title"><i className="fal fa-book me-2"></i> Mission Our University</span>
...
if(document.getElementById("Missionrent")){
    ReactDom.render(<Mission/>, document.getElementById("Missionrent"));
    }
