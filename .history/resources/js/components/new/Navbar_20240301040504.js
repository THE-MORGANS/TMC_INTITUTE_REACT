                                                        ...
                                                        <li>
                                                            ...
                                                            <a href=''>
                                                                <div className='row justify-content-center' style={{ color:'#333'}}>
                                                                    ...
                                                                    <div className='col-8' style={{marginLeft: '-20px', marginTop:'-5px'}}>
                                                                        <snap style={{fontWeight:'500'}}> Business Administration <br> (MBA )</snap>
                                                                    </div>
                                                                </div>
                                                            </a>
                                                            <a href=''>
                                                                <div className='row justify-content-center' style={{ color:'#333'}}>
                                                                    <div className='col-4'>
                                                                        <img src="https://snatikabucket.s3.ap-southeast-1.amazonaws.com/uploads/manage-cms/universities-image/651bc9aa000fd_universities_image" alt="Image" class="img-responsive"/>
                                                                    </div>
                                                                    <div className='col-8' style={{marginLeft: '-20px', marginTop:'-5px'}}>
                                                                        <snap style={{fontWeight:'500'}}>Strategic Management and Leadership (MBA)</snap>
                                                                    </div>
