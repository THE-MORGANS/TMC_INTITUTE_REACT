       ...
       <Navbar />
        <main class="bg-grey-faf9f8">
          ...
          <section className="products-carousel container">
            ...
            <section className="contact-us container" style="background-color:  #EDE9F2; border-radius:20px">
           
              <div className="p-4">
                <div className="row mb-5">
                  <div className="col-lg-4">
                    <p className="mb-4">College Level</p>
                    <h2 style=" font-weight:900" className="section-title text-left ">Don’t waste time in COVID-19 pandemic. Develop your skills.</h2>
                    ...
                    <div className="text-left mt-2">
                      <a href="#" className="btn btn-primary js-open-aside mb-xl-4 " style=" border-radius: 10px;" >Register Now</a>
