            ...
            <div className="overflow-hidden overflow-hidden bg-smoke space" id="about-sec" data-bg-src="assets/img/bg/about-5-bg.png">
                <div className="container">
                    ...
                    <div className="col-xl-6">
                        ...
                        <p className="mt-n2 mb-25" style={{text-align: 'justify'}}>
                        We are the leading and specialized provider of corporate training, including Governance, Risk Management, Compliance and Financial Crime Prevention and Leadership training. Our focus is on cultivating the right attitude and skills in your teams. To date, TMC 
            ...
            <section className="cta-area-3 space mb-40">
                <div className="container">
                    ...
                    <div className="col-lg-6 mb-30 mb-lg-0">
                        ...
                        <a onClick={handlelistcourses} style={{ cursor:'pointer'}} className="th-btn style8">Apply Now<i className="fas fa-arrow-right ms-2"></i></a>
                        </div>
                    </div>
                    <div className="col-lg-6">
                        ...
                        <a onClick={handlelistcourses}  style={{ cursor:'pointer'}} className="th-btn style8">Join With Us<i className="fas fa-arrow-right ms-2"></i></a>
                        </div>
                    </div>
                    </div>
                </div>
