            ...
            <div class="modal-content">
                ...
                <div class="modal-body ">
                    ...
                    {list.length > 0 ?  list.map((item, index)=>{
                        ...
                        //   <li className=" flex flex-row items-center justify-between px-2 py-2 overflow-x-scroll md:flex md:flex-row md:items-center md:justify-between md:px-2 md:py-2 md:overflow-x-hidden     lg:flex lg:flex-row lg:items-center lg:justify-between lg:px-2 lg:py-2 lg:overflow-x-hidden" key={index}>
