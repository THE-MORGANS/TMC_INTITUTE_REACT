  ...
  return (
    <div>
      ...
      <div className="th-cart-wrapper space-top space-extra-bottom">
                            ...
                            <div className="col-md-8 col-lg-7 col-xl-6">
                                ...
                                <div className="relative" >
                                    <PayPalScriptProvider options={{ "client-id": "AUBDz8zhTjw7acKU1_wB6b-ngtUEEsYD2vPbPtr6i8Lp5zHlvvgq-zhdpUBSuFNZ5qMlvaNB2SI23M5A" }}>
                                        <PayPalButtons style={{layout:'vertical',  zIndex: '1049' }}
        ...
        <div class="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabIndex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true"  style={{ zIndex: '1050', position: 'absolute' }}>
                                                    ...
                                                    <div className=" d-flex justify-content-between"> 
                                                        ...
                                                        <div className="d-flex justify-content-between" aria-label="">
                                                            <span className="w-24 space-x-4 flex flex-row items-center">
                                                                <a className=" border-none outline-none flex justify-center items-center "  onClick={()=>handleDelete(item.id)}>
