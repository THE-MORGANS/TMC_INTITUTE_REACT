                            ...
                            <div class="row align-items-center justify-content-between">
                                <div class="col-auto">
                                    <div class="header-logo">
                                        <a href="index.html"><img width="70" height="10" src="https://res.cloudinary.com/the-morgans-consortium/image/upload/v1659435270/Tmc%20institute/TMC_Institute_logo_kpv3d4.jpg" alt="TMC Institute"/></a>
                                    </div>
                                </div>
                                <div class="col-auto">
                                    <div class="row">
                                                    ...
                                                    <li class="menu-item-has-children">
                                                        ...
                                                        <ul class="sub-menu">
                                                            <li class="menu-item-has-children">
                                                                <a href="#">Academic</a>
                                                                <ul class="sub-menu">
                                                                    <li><a href="index.html">Diploma & Certificate</a></li>
                                                                    <li><a href="index.html">Bachelors</a></li>
                                                                    <li><a href="index.html">Masters</a></li>
                                                                    <li><a href="index.html">Doctorate</a></li>
                                                                </ul>
                                                            </li>
                                                            <li class="menu-item-has-children">
                                                                <a href="#">Professional</a>
                                                                <ul class="sub-menu">
                                                                    <li><a href="home1-onepage.html">LGCA</a></li>
                                                                    <li><a href="home1-onepage.html">OTHM </a></li>
                                                                    <li><a href="home1-onepage.html">GRC & Fincrime</a></li>
                                                                </ul>
                                                            </li>
                                                        </ul>
                                                    </li>
