                                ...
                                <div class="header-button">
                                    <div class="category-menu-wrap mr-5">
                                        <a class="menu-expand" href="#">
                                            <i class="fa-solid fa-grid-2 me-2 text-theme"></i>
                                            Categories <i class="fa-solid fa-angle-down ms-auto"></i>
                                        </a>
                                        <nav class="category-menu">
                                            <ul>
                                                <li>
                                                    <a href="course">Javascript</a>
                                                </li>
                                                <li>
                                                ...
                                                <li>
                                                    <a href="course">Content Writing</a>
                                                </li>
                                                <li>
                                                    <a href="course">Freelancing</a>
                                                </li>
                                                <li>
                                                    <a href="course">Startup Growth</a>
                                                </li>
                                                <li>
                                                    <a href="course">UI/UX Design</a>
                                                </li>
                                                <li>
                                                    <a href="course">Web Development</a>
                                                </li>
                                            </ul>
                                        </nav>
