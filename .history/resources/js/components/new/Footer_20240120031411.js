    ...
    <div>
        <footer className="footer footer_type_1">
            ...
            <div className="row row-cols-lg-5 row-cols-2">
                ...
                <ul className="sub-menu__list list-unstyled">
                    <li className="sub-menu__item"><a href="#" class="menu-link menu-link_us-s">Learners</a></li>
                    <li className="sub-menu__item"><a href="#" class="menu-link menu-link_us-s">Parteners</a></li>
