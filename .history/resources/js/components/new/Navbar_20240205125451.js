...
export default function Navbar() {
    ...
    return ( 
        <div>
            ...
            <div className="sidemenu-wrapperLogin d-none d-lg-block">
                                ...
                                <div class="header-links header-right">
                                    <ul>
                                        ...
                                        <li class="d-none d-lg-inline-block ">
                                            <i class="far fa-user"></i><a href="#" class="sideMenuToggle">Login / Register</a>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-auto d-none d-xl-block">
                                            <div class="header-button">
                                                ...
                                                <button type="button" class="icon-btn sideenuToggler"><i class="far fa-shopping-cart"></i> <span class="badge">5</span></button> 
