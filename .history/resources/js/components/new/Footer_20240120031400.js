        ...
        <footer className="footer footer_type_1">
            ...
            <div className="row row-cols-lg-5 row-cols-2">
                ...
                <ul className="sub-menu__list list-unstyled">
                    ...
                    <li class="sub-menu__item"><a href="#" className="menu-link menu-link_us-s">Insurance courses</a></li>
                    <li class="sub-menu__item"><a href="#" className="menu-link menu-link_us-s">Risk management</a></li>
                </ul>
                </div>
