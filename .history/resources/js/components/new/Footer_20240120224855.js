            ...
            <div className="footer-middle container">
                <div className="row row-cols-lg-5 row-cols-2">
                    ...
                    <ul className="sub-menu__list list-unstyled">
                        ...
                        <li className="sub-menu__item"><a onClick={(e)=>handleStudy(e)} className="menu-link menu-link_us-s">Terms</a></li>
                        <li className="sub-menu__item"><a onClick={(e)=>handleStudy(e)} className="menu-link menu-link_us-s">Privacy</a></li>
                    </ul>
                    </div>
