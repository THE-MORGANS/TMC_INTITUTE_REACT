                            ...
                            <div class="tab-pane fade active show" id="tab-list" role="tabpanel" aria-labelledby="tab-shop-list">
                                <div class="course-single-bottom">
                                    ...
                                    {Post.map((item, index)=>{
                                     ...
                                     <li className={hover == index?"nav-item tip":"tip"}  role="presentation" key={index} onMouseLeave={()=>handleLeave()} onMouseOver={()=>handleOver(index)} onClick={()=>handlemouse(index, item)}>
