       ...
       <Navbar />
        <main class="bg-grey-faf9f8">
          ...
          <section className="products-carousel container">
              <h2 style={{color: '#37226C' }} className="section-title text-center fw-normal mb-1 mb-md-3 pb-xl-3 mb-xl-4">Featured Courses</h2>
              <p   className="fs-6  text-center fw-small mb-1 mb-md-3 pb-xl-3 mb-xl-4  align-content-center m-3">
                        ...
                        <div className="bg-white shadow-sm rounded-lg uk-transition-toggle md:flex">
                            ...
                            {username?<div className="font-semibold mt-3">{item.instructor == null?"":'By'} {item.instructor} </div>:""}
                                <div className="mt-1 flex items-center justify-between">
                                    ...
                                    <CurrencyFormat value={moneyTalks(item.converted, item.price, item.currency_name)} displayType={'text'} thousandSeparator={true} prefix={currencysymbol.currency.symbol} /></div>
                                </div>
                            </div>
                        </div>
