		...
		<section className="space-top space-extra-bottom">
			<div className="container">
				...
				<div className="col-xxl-9 col-lg-10">
					...
					<h3 class=" fw-bold mb-20 h5">5. Legal ground for personal data processing The TMC Institute may process the personal data set out above on one or more of the following:</h3>
					<div className="checklist mb-20">
						<ul>
