                                                        ...
                                                        <li>
                                                            <a href=''>
                                                                ...
                                                                <a href=''>
                                                                    <div className='row justify-content-center' style={{ color:'#333'}}>
                                                                        <div className='col-2'>
                                                                            <img w src="https://snatikabucket.s3.ap-southeast-1.amazonaws.com/uploads/manage-cms/universities-image/651bc8d942e76_universities_image" alt="Image" class="img-responsive"/>
                                                                        </div>
                                                                        <div className='col-10' style={{marginLeft: '-20px', marginTop:'-5px'}}>
                                                    ...
                                                    <li>
                                                        ...
                                                        <li>
                                                            <a href=''>
                                                                <div className='row justify-content-center' style={{ color:'#333'}}>
                                                                    <div className='col-2'>
                                                                        <img  width={120} height={40}  src="https://snatikabucket.s3.ap-southeast-1.amazonaws.com/uploads/manage-cms/universities-image/655ae8ea0e3cf_universities_image" alt="Image" class="img-responsive"/>                                                                      
                                                                    </div>
                                                                    <div className='col-10' style={{marginLeft: '-20px', marginTop:'-5px'}}>
                                                    ...
                                                    <li>
                                                        ...
                                                        <li>
                                                            <a href=''>
                                                                <div className='row justify-content-center' style={{ color:'#333'}}>
                                                                    <div className='col-2'>
                                                                        <img  width={120} height={40}  src="https://snatikabucket.s3.ap-southeast-1.amazonaws.com/uploads/manage-cms/universities-image/651bc97dc3835_universities_image" alt="Image" class="img-responsive"/>                                                                      
                                                                    </div>
                                                                    <div className='col-10' style={{marginLeft: '-20px', marginTop:'-5px'}}>
                                                            ...
                                                            <a href=''>
                                                                <div className='row justify-content-center' style={{ color:'#333'}}>
                                                                    <div className='col-2'>
                                                                        <img  width={120} height={40}  src="https://snatikabucket.s3.ap-southeast-1.amazonaws.com/uploads/manage-cms/universities-image/651bc98d9e7d7_universities_image" alt="Image" class="img-responsive"/>                                                                      
                                                                    </div>
                                                                    <div className='col-10' style={{marginLeft: '-20px', marginTop:'-5px'}}>
