                    ...
                    <div className="col-lg-6 mb-30 mb-lg-0">
                        ...
                        <div className="title-area mb-40">
                            ...
                            <h4 className="sec-title text-white">
                                ...
                                risk management, corporate governance, prudential requirements, or just a finance understanding and awareness, our team has the right specialist to offer you what you need.
                            </h4>
                        </div>
