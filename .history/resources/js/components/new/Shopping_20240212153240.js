  ...
  return (
    <div>
      ...
      <div className="th-cart-wrapper space-top space-extra-bottom">
                    ...
                    <div className="row justify-content-end">
                        <div className="col-md-8 col-lg-7 col-xl-6">
                            ...
                            <div className="flex items-center justify-center mt-4 space-x-1.5 text-center">
                                ...
                                <a  class="th-btn style5 " data-bs-toggle="modal" data-bs-target="#staticBackdrop">
        ...
        <div className={showgroup?"th-cart-wrapper space-top space-extra-bottom" : 'hidden z-0' }>
                    <p>Modl</p>
        </div>
