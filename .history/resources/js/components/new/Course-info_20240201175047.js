                    ...
                    <div className="course-single">
                        <div className="course-single-top">
                            ...
                            <li className="course-single-meta-author">
                                ...
                                <a href="course.html">{single.instructor == null ? '' : ff}</a>
                                </span>
                            </li>
                            ...
                            <li>
                                ...
                                {single.instructor != null && (
  <li>
    Created by{' '}
    <a href="#" className="text-white font-bold hover:underline hover:text-white">
      {single.instructor}
    </a>
  </li>
)}
                                {/* {single.instructor == null?'':<li> Created by 
                                    <a href="#" className="text-white fond-bold hover:underline hover:text-white">
                                        {single.instructor == null?'':single.instructor} 
                                    </a>
                                    </li>} */}
                ...
                <div class="col-xxl-3 col-lg-4">
                    <aside class="sidebar-area">
                        <div class="widget widget_info">
                            ...
                            >$90.00 <span class="tag">25% Off</span></span
                            >
                            ...
                            <ul>
                                ...
                                <strong>Instructor: </strong><span>Kevin Perry</span>
                                </li>
                                <li>
                                ...
                                <strong>Duration: </strong><span>15h 30m 36s</span>
                                </li>
                                <li>
                                <i class="fa-light fa-tag"></i>
                                <strong>Course level: </strong><span>Beginners</span>
                                </li>
                                <li>
                                ...
                                <strong>Quizzes: </strong><span>04</span>
                                </li>
                            </ul>
                            </div>
                            <a
