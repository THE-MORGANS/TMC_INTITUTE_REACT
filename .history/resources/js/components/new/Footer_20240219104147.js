                        ...
                        <div className="row justify-content-between">
                            ...
                            <div className="col-md-6 col-xl-auto">
                                <div className="widget widget_nav_menu footer-widget">
                                    ...
                                    <div className="menu-all-pages-container">
                                        <ul className="menu">
                                            <li><a onClick={(e)=>handlelistcourses(e)} style={{cursor:'pointer, colo:'white'}}>TMC Courses</a></li>
                                            <li><a href="#" style={{cursor:'pointer'}}>SNATIKA</a></li>
                                            <li><a onClick={handleLG} style={{cursor:'pointer'}}>LGCA</a></li>
                                            <li><a href="#" style={{cursor:'pointer'}}>Admissions</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
