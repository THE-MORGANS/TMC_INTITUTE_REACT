                        ...
                        <div className="course-box">
                          ...
                          <div className="course-content">
                            ...
                            <h3 className="course-title">
                              ...
                              {item.coursename.substring(0, 60)+'...'} 
                              </a>
                            </h3>
                            ...
                            <div className="course-author">
                              <div className="author-info">
                                ...
                                {usercourse?
                                  ...
                                  username?
                                  <a  onClick={()=>handleCart(single.id)} class="th-btn style5 mt-10"> {getBtnText(single.id) == 'text-2xl text-green-400'? 'In Cart': 'Add to Cart'} </a> :
