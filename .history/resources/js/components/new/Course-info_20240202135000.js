                ...
                <div class="col-xxl-3 col-lg-4">
                    <aside class="sidebar-area">
                        <div class="widget widget_info">
                            ...
                            {/* <span class="h4 course-price"> {single.price} <span class="tag">25% Off</span></span> */}
                            <span className='h4 course-price'>
                                ...
                                <CurrencyFormat value={moneyTalks(single.converted, single.price, item.currency_name)} displayType={'text'} thousandSeparator={true} prefix={symbol} /> 
                            </span>
