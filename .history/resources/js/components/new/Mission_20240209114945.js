        ...
        <div className="">
            ...
            <div className="breadcumb-wrapper" data-bg-src="assets/img/bg/breadcumb-bg.jpg" data-overlay="title" data-opacity="8">
                ...
                <div className="container">
                    ...
                    <h1 className="breadcumb-title">Mi Us</h1>
            ...
            <div className="overflow-hidden overflow-hidden bg-smoke space" id="Mi-sec" data-bg-src="assets/img/bg/Mi-5-bg.png">
                <div className="container">
                    <div className="row">
                    <div className="col-xl-6 mb-50 mb-xl-0">
                        <div className="img-box4">
                        <div className="img1">
                            <img className="tilt-active" src="assets/img/normal/Mi_5_1.png" alt="Mi" />
                        </div>
                        <div className="Mi-grid">
                            <h3 className="Mi-grid_year"><span className="counter-number">10</span>k+</h3>
                            <p className="Mi-grid_text">Students Active Our Courses</p>
                        </div>
                        <div className="img2">
                            <img className="tilt-active" src="assets/img/normal/Mi_5_2.png" alt="Mi" />
                        </div>
                        <div className="shape1 shape-mockup jump" data-bottom="0" data-left="-46px">
                            <img src="assets/img/normal/Mi_5_1shape.png" alt="Mi" />
                        </div>
                        </div>
                    </div>
                    <div className="col-xl-6">
                        <div className="title-area mb-35">
                        <span className="sub-title"><i className="fal fa-book me-2"></i> Mi Our University</span>
                        ...
                        <div className="col-lg-6">
                            ...
                            <div className="Mi-grid-icon">
                                <img src="assets/img/icon/Mi-grid-icon2-1.svg" alt="icon" />
                            </div>
                        ...
                        <div className="col-lg-6">
                            <div className="Mi-grid3">
                            <div className="icon">
                                <img src="assets/img/icon/Mi-grid-icon2-2.svg" alt="icon" />
                            </div>
                            <div className="details">
                        ...
                        <div className="col-md-auto">
                            <div className="Mi-grid_img mb-30 mb-md-0">
                            <img src="assets/img/normal/Mi_1_4.png" alt="img" />
                            </div>
                        </div>
...
if(document.getElementById("Mirent")){
    ReactDom.render(<Mi/>, document.getElementById("Mirent"));
    }
