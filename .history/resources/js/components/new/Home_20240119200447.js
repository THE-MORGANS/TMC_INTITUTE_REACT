          ...
          <section className="grid-banner container">
            ...
            <div className="row">
              ...
              <div className="col-md-4 d-flex align-items-center" >
                <a href="#" className="btn btn-primary mb-xl-4 bg-white no-border" style="border-radius: 10px; ">
              ...
              <div className="col-md-4 d-flex align-items-center" >
                <a href="#" className="btn btn-primary mb-xl-4 bg-white no-border" style="borderadius: 10px}}">
