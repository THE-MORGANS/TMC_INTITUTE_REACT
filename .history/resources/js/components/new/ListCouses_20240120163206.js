            ...
            <section class="shop-main container p-3" style={{backgroundColor: '#eee'}}>
                ...
                <div class="products-grid row row-cols-1 row-cols-md-3 row-cols-lg-2 row-cols-xl-2" id="products-grid" >
                    ...
                    <div class="product-card-wrapper " >
                        <div class="blog-list__item" style={{backgroundColor: '#fff', padding:'20px', borderRadius: '20px'}}>
                            <div class="blog-list__item-image">
                              <img style={{borderRadius: '10px'}}  loading="lazy" class="h-auto" src="../images/courses/course-9.png" width="680" height="493" alt="" />
                            </div>
                            <div class="blog-list__item-detail">
                              <div class="pc__info position-relative">
                                <div class=" d-flex  justify-content-between  ">
                    ...
                    <div class="product-card-wrapper " >
                        <div class="blog-list__item" style={{backgroundColor: '#fff', padding:'20px', borderRadius: '20px'}}>
                            <div class="blog-list__item-image">
                              <img style={{borderRadius: '10px'}}  loading="lazy" class="h-auto" src="../images/courses/course-10.png" width="680" height="493" alt="" />
                            </div>
                            <div class="blog-list__item-detail">
                              <div class="pc__info position-relative">
                                <div class=" d-flex  justify-content-between  ">
                    ...
                    <div class="product-card-wrapper " >
                        <div class="blog-list__item" style={{backgroundColor: '#fff', padding:'20px', borderRadius: '20px'}}>
                            <div class="blog-list__item-image">
                              <img style={{borderRadius: '10px'}}  loading="lazy" class="h-auto" src="../images/courses/course-11.png" width="680" height="493" alt="" />
                            </div>
                            <div class="blog-list__item-detail">
                              <div class="pc__info position-relative">
                                <div class=" d-flex  justify-content-between  ">
                    ...
                    <div class="product-card-wrapper " >
                        <div class="blog-list__item" style={{backgroundColor: '#fff', padding:'20px', borderRadius: '20px'}}>
                            <div class="blog-list__item-image">
                              <img style={{borderRadius: '10px'}}  loading="lazy" class="h-auto" src="../images/courses/course-12.png" width="680" height="493" alt="" />
                            </div>
                            <div class="blog-list__item-detail">
                              <div class="pc__info position-relative">
                                <div class=" d-flex  justify-content-between  ">
                    ...
                    <div class="product-card-wrapper " >
                        <div class="blog-list__item" style={{backgroundColor: '#fff', padding:'20px', borderRadius: '20px'}}>
                            <div class="blog-list__item-image">
                              <img style={{borderRadius: '10px'}}  loading="lazy" class="h-auto" src="../images/courses/course-13.png" width="680" height="493" alt="" />
                            </div>
                            <div class="blog-list__item-detail">
                              <div class="pc__info position-relative">
                                <div class=" d-flex  justify-content-between  ">
                    ...
                    <div class="product-card-wrapper " >
                        <div class="blog-list__item" style={{backgroundColor: '#fff', padding:'20px', borderRadius: '20px'}}>
                            <div class="blog-list__item-image">
                              <img style={{borderRadius: '10px'}}  loading="lazy" class="h-auto" src="../images/courses/course-14.png" width="680" height="493" alt="" />
                            </div>
                            <div class="blog-list__item-detail">
                              <div class="pc__info position-relative">
                                <div class=" d-flex  justify-content-between  ">
                    ...
                    <div class="row mb-5">
                        ...
                        <div class=" col-xl-4">
                            ...
                            <div class="text-left mt-2">
                                <form action="" class="footer-newsletter__form position-relative bg-body">
                                <input class="form-control border-white" type="email" name="email" placeholder="Enter your email" style={{backgroundImage: 'url(&quot;data:image/png;base64,), 
                                !important'; backgroundRepeat: no-repeat; background-size: 70px; background-position: 97% center; cursor: auto;" data-temp-mail-org="1">
