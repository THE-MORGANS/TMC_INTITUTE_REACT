  ...
  return (
    <div>
      ...
      <div className="footer-top">
        ...
        <div className="footer-contact-wrap" style={{ display: 'flex', justifyContent: 'space-between' }}>
            ...
            <div className="footer-contact">
              ...
              <div className="media-body">
                ...
                <a href="tel+11234567890" className="footer-contact_link"> +234 (0) 915-341-4314</a>
              </div>
            </div>
            ...
            <div className="footer-contact">
              ...
              <div className="media-body">
                ...
                <a href="mailto:enquiries@tmcinstitute.com" className="footer-contact_link">enquiries@tmcinstitute.com</a>
              </div>
            </div>
          </div>
        </div>
