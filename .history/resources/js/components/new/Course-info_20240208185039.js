...
export default function Course_info() {
   ...
   // Logic to get current posts
    ...
    //     if (cart) {
    //         return 'text-2xl text-green-400'; // Return this if item with id exists
    //     } else {
    //         return 'text-2xl text-[#A32926]'; // Return this if item with id doesn't exist
    //     }
    // };
                ...
                <div class="col-xxl-3 col-lg-4">
                    <aside class="sidebar-area">
                        <div class="widget widget_info">
                            ...
                            {/* <p key={id} className={getBtnText(single.id)}>Item {single.id}: {getBtnText(single.id)}</p> */}
                            ...
                            {usercourse?
                                ...
                                <a  className="flex items-center justify-center h-10 px-6 rounded-md bg-blue-600 text-white cursor-pointer"  style={{color:'white' }}> 
                                {/* {getBtnText(single.id) == 'text-2xl text-green-400'? 'In Cart': 'Add to Cart'}   */}
                                 'Add to Cart'   
                                </a> :
                                ...
                                <a  className="flex items-center justify-center h-10 px-6 rounded-md bg-[#A32926] text-white cursor-pointer" > Enrol as a Student </a>
                            }
                        </div>
                        </aside>
                </div>
