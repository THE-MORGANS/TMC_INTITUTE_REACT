                    ...
                    <div className="widget woocommerce widget_shopping_cart">
                        ...
                        <div className="widget_shopping_cart_content">
                            ...
                            <p className="woocommerce-mini-cart__buttons buttons">
                                <a data-name='signup' onClick={(e)=>handleLinks(e)} className="th-btn wc-forward" >
                                    <FaUserAlt/> Individual
                                </a>{" "}
                                <a data-name='companyregister' onClick={(e)=>handleLinks(e)} className="th-btn checkout wc-forward">
                        ...
                        <ul>
                            ...
                            <li class="menu-item-has-children">
                                ...
                                <ul class="sub-menu">
                                    ...
                                    <li>
                                        <a href="">Our Partiners</a>
                                    </li>
                                </ul>
                            </li>
                            <li>
                                <a onClick={(e) => handleHowtoAppy(e)}>
                                    How to Apply
                                </a>
                            </li>
                            <li>
                                <a onClick={(e) => handleContact(e)}>Contact</a>
                            </li>
                        </ul>
                    </div>
                </div>
                                ...
                                <div class="header-links">
                                    <ul>
                                        <li>
                                            ...
                                            <a href="tel:+11156456825">
                                                +111 (564) 568 25
                                            </a>
                                        </li>
                                        <li class="d-none d-xl-inline-block">
                                            <i class="far fa-envelope"></i>
                                            <a href="mailto:info@Edura.com">
                                                info@edura.com
                                            </a>
                                        </li>
                                        <li>
                            ...
                            <div class="col-auto">
                                <div class="header-links header-right">
                                    <ul>
                                        ...
                                        <li class="d-none d-lg-inline-block sideMenuToggle">
                                            <i class="far fa-user"></i>
                                            <a href="" class="sideMenuToggle">
                                                Login / Register
                                            </a>
                                        </li>
                                    </ul>
