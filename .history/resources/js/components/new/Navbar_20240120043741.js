                    ...
                    <div className="header-desk header-desk_type_1">
                        ...
                        <nav className="navigation">
                            <ul className="navigation__list list-unstyled d-flex">
                                ...
                                <li className="navigation__item">
                                    <a onClick={(e)=>handle(e)} className="navigation__link">
                                        Testimonials
                                    </a>
                                </li>
                            
                                <li className="navigation__item">
                                    <a onClick={(e)=>handleLinks(e)} className="navigation__link">
                                        How to Apply
                                    </a>
                                </li>
                                <li className="navigation__item">
                                    <a onClick={(e)=>handleLinks(e)} className="navigation__link">Contact us</a>
                                </li>
                            </ul>
                        </nav>
