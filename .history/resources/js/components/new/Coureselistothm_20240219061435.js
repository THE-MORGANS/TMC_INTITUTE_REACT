                    ...
                    <div className="col-xl-3 col-lg-4 order-lg-1">
                        <div class="widget widget_search">
                            ...
                            <div class="widget widget_price_filter style2">
                                ...
                                <ul>
                                    <li>
                                        <input id="ascCheckbox" name="orderby" checked={orderBy === 'ASC'} type="checkbox" data-name="ASC" onChange={(e)=>handleArrange(e)} t/>
                                        <label for="freecheck">
                                            ASC<span class="checkmark"></span>
                                        </label>
                                    </li>
                                    <li>
                                        <input id="descCheckbox" name="orderby" checked={orderBy === 'DESC'} type="checkbox" data-name="DESC" onChange={(e)=>handleArrange(e)} t/>
                                        <label for="paidcheck">
                                            DESC<span class="checkmark"></span>
                                        </label>
                                    </li>
                                </ul>
                            </div>
                                ...
                                {data.map((item, index)=>{
                                    return <div className="col-md-6 col-xl-4">
                                            ...
                                            <div className="course-box style2" onClick={()=>handleLink(item.id)}>
                                                <div class="course-img">
                                                    <img src={item.picture} style={{ width: '450px', height: '250px' }} alt="img"/>
                                                    <span class="tag">
