                                ...
                                <div class="header-links header-right">
                                    <ul>
                                        ...
                                        {username ?
                                            ...
                                            <>
                                                <li class="d-none d-lg-inline-block">
                                                <i class="far fa-user"></i> {''}<a onClick={(e)=>handlesignup(e)} class="sideMenuToggler" >Individual</a>
                                                </li>
                                                <li class="d-none d-lg-inline-block">
                                    ...
                                    <div class="row">
                                        ...
                                        {username ?
                                            ...
                                            <div class="col-auto">
                                                <div class="category-menu-wrap">
                                                    ...
                                                    Welcome, {username},  <span> {usersemail} </span  <i class="fa-solid fa-angle-down ms-auto"></i>
                                                    </a>
                                                    <nav class="category-menu">
                                                        <ul>
                                                            <li>
                                                                <a onClick={handleAcc}>My Account</a>
                                                            </li>
                                                            <li>
                                                                <a onClick={handleMycourse}> My Courses</a>
                                                            </li>
                                                            <li>
                                                                <a honClick={handleLogout}> Log Out </a>
                                                            </li>
                                                        </ul>
                                                    </nav>
                                                </div>
                                        ...
                                        <div class="col-auto">
                                            <div class="category-menu-wrap">
                                                <a class="menu-expand" href="#">
                                                <i class="far fa-user"></i>
                                                    Account <i class="fa-solid fa-angle-down ms-auto"></i>
                                                </a>
                                                <nav class="category-menu">
                                                    <ul>
                                                        <li>
                                                            <a href="course">My Account</a>
                                                        </li>
                                                        <li>
                                                            <a href="course"> My Courses</a>
                                                        </li>
                                                        <li>
                                                            <a href="course"> Log Out </a>
                                                        </li>
                                                    </ul>
                                                </nav>
                                            </div>
