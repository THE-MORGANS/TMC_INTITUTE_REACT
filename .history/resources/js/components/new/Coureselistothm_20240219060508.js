                    ...
                    <div className="col-xl-3 col-lg-4 order-lg-1">
                        <div class="widget widget_search">
                            ...
                            <div class="widget widget_price_filter style2">
                                ...
                                <ul>
                                    <li>
                                        <input id="freecheck" name="steve" type="checkbox" checked="checked" onChange={(e)=>handleArrange(e)} />
                                        <label for="freecheck">
                                            ASC<span class="checkmark"></span>
                                        </label>
                                    </li>
                                    <li>
                                        <input id="paidcheck" name="steve" type="checkbox" onChange={(e)=>handleArrange(e)} />
                                        <label for="paidcheck">
