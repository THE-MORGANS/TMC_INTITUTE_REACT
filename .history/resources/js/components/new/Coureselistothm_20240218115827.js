                                ...
                                <div class="course-single-bottom">
                                    ...
                                    {Post.map((item, index)=>{
                                     ...
                                     <li className={hover == index?"nav-item tip":"tip"}  role="presentation" key={index} onMouseLeave={()=>handleLeave()} onMouseOver={()=>handleOver(index)} onClick={()=>handlemouse(index, item)}>
                                        <a class="nav-link active" lassName={overon == index?"top-[-18px] absolute w-100 text-sm bg-[#A32926]  text-white":'hidden'} id="description-tab" data-bs-toggle="tab" href="#Coursedescription" role="tab" aria-controls="Coursedescription" aria-selected="true">
