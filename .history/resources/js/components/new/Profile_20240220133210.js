  ...
  return (
    <div>
      ...
      <div class="th-checkout-wrapper space-top space-extra-bottom">
            <div class="container">
                <a class="th-btn mb-20" data-name="Logout" onClick={(e)=>handleLinks(e)}> Logout</a>
                ...
                <form action="#" class="woocommerce-checkout mt-40">
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 form-group">
                                    <label> Email </label>
                                    <input disabled type="text" class="form-control" placeholder="" value= {email}/>
                                </div>
                                <div class="col-12 form-group">
                                    <label> Phone Number </label>
                                    <input disabled type="text" class="form-control" placeholder="Phone number" value={additional === null?"no data":additional.phone_number} />
                                </div>
                                <div class="col-md-6 form-group">
                                    <label> Date of Birth (DD/MM/YYYY) </label>
                                    <input disabled type="text" class="form-control" placeholder="DOB" value= { additional === null?"no data":new Date(additional.dob).toLocaleDateString("en-US")} />
                                </div>
                                <div class="col-md-6 form-group">
                                    <label> Nationality </label>
                                    <input disabled type="text" class="form-control" placeholder="Nationality" value= {additional === null?"no data":additional.nationality} />
                                </div>
                                <div class="col-12 form-group">
                                    <label> Address </label>
                                    <input disabled type="text" class="form-control" placeholder="Country of Birth" value= {additional === null?"no data":additional.current_address} />
                                </div>
                    ...
                    <div class="form-row place-order">
                      ...
                      {additional != null?
                        <a  class="th-btn" data-name="edit" onClick={(e)=>handleClick(e)} style={{ cursor:'pointer'}}>Edit Profile</a>
                        <a className='bg-[#A32926] py-3 w-44 px-2 rounded-md text-sm text-white  sm:bg-[#A32926] sm:py-3 sm:w-44 sm:px-2 sm:rounded-md sm:text-sm sm:text-white  md:bg-[#A32926] md:py-3 md:w-44 md:px-2 md:rounded-md md:text-sm md:text-white lg:bg-[#A32926] lg:py-3 lg:px-2 lg:rounded-md lg:text-sm lg:text-white' data-name="edit" onClick={(e)=>handleClick(e)}>
                        Edit profile
                        </a>
                      :
                        <a class="th-btn" onClick={handleback}  style={{ cursor:'pointer'}}> Back Home</a>
                      }
