                    ...
                    <div className="col-xl-3 col-lg-4 order-lg-1">
                        <div class="widget widget_search">
                            ...
                            <div class="widget widget_price_filter style2">
                                ...
                                <ul>
                                    <li>
                                        <input id="freecheck" name="freecheck" type="checkbox" data-name="ASC" onChange={(e)=>handleArrange(e)} t/>
                                        <label for="freecheck">
                                            ASC<span class="checkmark"></span>
                                        </label>
                                    </li>
                                    <li>
                                        <input id="paidcheck" name="paidcheck" type="checkbox" data-name="DESC" onChange={(e)=>handleArrange(e)} t/>
                                        <label for="paidcheck">
