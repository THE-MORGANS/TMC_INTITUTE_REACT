                        ...
                        <div class="widget widget_search">
                            ...
                            <div class="widget widget_time_duration style2">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <input id="timecheck3" checked={orderbystat === 'g,h,i,j,k,l'} name="alpha" data-name="m,n,o,p,q,r" onChange={(e)=>handleAlphabetical(e)} type="checkbox"/>
                                        <label for="timecheck3">
                                            M-R <span class="checkmark"></span>
                                        </label>
                                    </li>
                                    <li>
                                        <input id="timecheck3" checked={orderbystat === 'g,h,i,j,k,l'} name="alpha" type="checkbox"/>
                                        <label for="timecheck3">
