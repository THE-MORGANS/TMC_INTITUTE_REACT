                ...
                <div className="shop-sidebar side-sticky bg-body" id="shopFilter">
                    ...
                    <div className="accordion" id="brand-filters">
                        ...
                        <div className="accordion-item mb-4 pb-3">
                            ...
                            <div id="accordion-filter-brand1" className="accordion-collapse collapse show border-0" aria-labelledby="accordion-heading-brand" data-bs-parent="#brand-filters">
