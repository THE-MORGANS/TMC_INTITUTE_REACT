                                    ...
                                    <div className="product-card mb-3 mb-md-4 mb-xxl-5">
                                        ...
                                        <div className="pc__info position-relative">
                                            <div className="row">
                                                ...
                                                <div className="col">
                                                    <a href="../demo/cart.html" {{color: '#A32926'}} className="btn-round pc__btn-wl position-absolute top-0 end-0 bg-transparent  js-add-wishlist btn btn-round btn-hover-red  text-uppercase me-2" data-aside="cartDrawer" title="Add To Cart">
                                                        <svg  width="14" height="14" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                            <use href="#icon_cart" />
                                                        </svg>
                                                    </a>
