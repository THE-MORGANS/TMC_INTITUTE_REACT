                                                ...
                                                <ul className='sub-menu' style={{}}>
                                                    <li class="menu-item-has-children">
                                                        ...
                                                        <li>
                                                            ...
                                                            <li>
                                                                <a href=''>
                                                                <div className='row' style={{ color:'#333', alignItems: 'center' }}>
    <div className='col-2'>
        <img width={120} height={40} src="https://snatikabucket.s3.ap-southeast-1.amazonaws.com/uploads/manage-cms/universities-image/651bc9b74c6d5_universities_image" alt="Image" className="img-responsive"/>
    </div>
    <div className='col-10' style={{marginLeft: '-20px', marginTop:'-5px'}}>
        <snap style={{fontWeight:'500'}}>Business Management & Strategy (BA Hons)</snap>
                                                                ...
                                                                <a href=''>
                                                                    <div className='row' style={{ color:'#333'}}>
                                                                        <div className='col-2'>
                                                                            <img width={120} height={40} src="https://snatikabucket.s3.ap-southeast-1.amazonaws.com/uploads/manage-cms/universities-image/651bc8d942e76_universities_image" alt="Image" class="img-responsive"/>
                                                                        </div>
                                                                        <div className='col-10' style={{marginLeft: '-20px', marginTop:'-5px'}}>
                                                        ...
                                                        <li>
                                                            ...
                                                            <li>
                                                                <a href=''>
                                                                    <div className='row' style={{ color:'#333'}}>
                                                                        <div className='col-2'>
                                                                            <img  width={100} height={30} src="https://snatikabucket.s3.ap-southeast-1.amazonaws.com/uploads/manage-cms/universities-image/655ae8ea0e3cf_universities_image" alt="Image" class="img-responsive"/>                                                                      
                                                                        </div>
                                                                        <div className='col-10' style={{marginLeft: '-20px', marginTop:'-5px'}}>
                                                                ...
                                                                <a href=''>
                                                                    <div className='row' style={{ color:'#333'}}>
                                                                        <div className='col-2'>
                                                                            <img width={100} height={30} src="https://snatikabucket.s3.ap-southeast-1.amazonaws.com/uploads/manage-cms/universities-image/651bc96eba4c2_universities_image" alt="Image" class="img-responsive"/>
                                                                        </div>
                                                                        <div className='col-10' style={{marginLeft: '-20px', marginTop:'-5px'}}>
                                                                ...
                                                                <a href=''>
                                                                    <div className='row' style={{ color:'#333'}}>
                                                                        <div className='col-2'>
                                                                            <img width={100} height={30} src="https://snatikabucket.s3.ap-southeast-1.amazonaws.com/uploads/manage-cms/universities-image/651bc8d942e76_universities_image" alt="Image" class="img-responsive"/>
                                                                        </div>
                                                                        <div className='col-10' style={{marginLeft: '-20px', marginTop:'-5px'}}>
                                                                ...
                                                                <a href=''>
                                                                    <div className='row' style={{ color:'#333'}}>
                                                                        <div className='col-2'>
                                                                            <img width={100} height={30} src="https://snatikabucket.s3.ap-southeast-1.amazonaws.com/uploads/manage-cms/universities-image/651bc9aa000fd_universities_image" alt="Image" class="img-responsive"/>
                                                                        </div>
                                                                        <div className='col-10' style={{marginLeft: '-20px', marginTop:'-5px'}}>
                                                                            <snap style={{fontWeight:'500'}}>Strategic Management and Leadership (MBA)</snap>
                                                                        </div>
                                                                ...
                                                                <a href=''>
                                                                    <div className='row' style={{ color:'#333'}}>
                                                                        ...
                                                                        <div className='col-10' style={{marginLeft: '-20px', marginTop:'-5px'}}>
                                                                            <snap style={{fontWeight:'500'}}> Project Management (MBA)</snap>
                                                                        </div>
                                                                    </div>
                                                                </a>
                                                                <a href=''>
                                                                    <div className='row' style={{ color:'#333'}}>
                                                                        <div className='col-2'>
                                                                            <img width={100} height={30} src="https://snatikabucket.s3.ap-southeast-1.amazonaws.com/uploads/manage-cms/universities-image/651bc9b74c6d5_universities_image" alt="Image" class="img-responsive"/>
                                                                        </div>
                                                                        <div className='col-10' style={{marginLeft: '-20px', marginTop:'-5px'}}>
                                                                            <snap style={{fontWeight:'500'}}> Strategic Management and Leadership (MBA)</snap>
                                                                        </div>
                                                                ...
                                                                <a href=''>
                                                                    <div className='row' style={{ color:'#333'}}>
                                                                        ...
                                                                        <div className='col-10' style={{marginLeft: '-20px', marginTop:'-5px'}}>
                                                                            <snap style={{fontWeight:'500'}}> Risk Management (MBA)</snap>
                                                                        </div>
                                                                    </div>
                                                                </a>
                                                                <a href=''>
                                                                    <div className='row' style={{ color:'#333'}}>
                                                                        ...
                                                                        <div className='col-10' style={{marginLeft: '-20px', marginTop:'-5px'}}>
                                                                            <snap style={{fontWeight:'500'}}> Oil & Gas Management (MBA)</snap>
                                                                        </div>
                                                                    </div>
                                                                </a>
                                                                <a href=''>
                                                                    <div className='row' style={{ color:'#333'}}>
                                                                        ...
                                                                        <div className='col-10' style={{marginLeft: '-20px', marginTop:'-5px'}}>
                                                                            <snap style={{fontWeight:'500'}}>Engineering Management (MBA)</snap>
                                                                        </div>
                                                                    </div>
                                                                </a>
                                                                <a href=''>
                                                                    <div className='row' style={{ color:'#333'}}>
                                                                        ...
                                                                        <div className='col-10' style={{marginLeft: '-20px', marginTop:'-5px'}}>
                                                                            <snap style={{fontWeight:'500'}}>Facilities Management (MBA)</snap>
                                                                        </div>
                                                                    </div>
                                                                </a>
                                                                <a href=''>
                                ...
                                <div class="row">
                                    <div class="col-auto">
                                        <div class="header-button">
                                            ...
                                            <a href="contact.html" class="th-btn ml-20">
