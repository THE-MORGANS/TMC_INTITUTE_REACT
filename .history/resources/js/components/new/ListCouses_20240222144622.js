...
function ListCouses() {
    ...
    const[postPerPage, setPostsperPage] = useState(14)
    ...
    const handleNext = (selectedPage) => {
        setCurrentPage(selectedPage + 1); // ReactPaginate uses 0-based indexing
    };
    const handleNextt = (data)=>{
        if(orderbystat == ''){
                ...
                <div class="th-sort-bar">
                    <div class="row justify-content-between align-items-center">
                        <div class="col-md-auto">
                            <span class="course-result-count">We found <span class="text-theme">1 courses</span> available for you</span>
                        </div>
