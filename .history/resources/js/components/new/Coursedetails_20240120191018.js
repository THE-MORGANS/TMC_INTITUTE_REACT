                        ...
                        <div class="tab-pane fade show active" id="collections-tab-6" role="tabpanel" aria-labelledby="collections-tab-6-trigger">
                            <div class="row">
                                ...
                                <div class="col-md-6 col-lg-4 ">
                                    ...
                                    <div className="container product-card product-card_style8 hover-container">
                                        <div class="product-card-wrapper mb-xl-3"  >
                                            <div className="row" style={{backgroundColor: '#fff', borderRadius:'20px'}}>
                                                {/* Image on the Right */}
                                                <div className="col-md-6">
                                                    <img
                                                        src="your-image-source.jpg"
                                                        alt="Your Alt Text"
                                                        className="img-fluid" // Optional: Make the image responsive
                                                    />
                                                </div>
                                                {/* Text on the Left */}
                                                <div className="col-md-6">
                                                    <h2>Your Text Goes Here</h2>
                                                    <p>Any additional text or content can go here.</p>
                                                </div>
                                    ...
                                    <div class="product-card product-card_style8 hover-container" >
                                        <div class="product-card-wrapper mb-xl-3"  >
                                            <div class="row p-3" style={{backgroundColor: '#fff', borderRadius:'20px'}}>
                                        ...
                                        <div class="product-card-wrapper mb-xl-3"  >
                                            <div class="row  p-3" style={{backgroundColor: '#fff', borderRadius:'20px'}}>
                                                ...
                                                <div style={pcInfo}  class="pc__info position-relative col-lg-6" >
                                                    <div class="mb-3 mb-xl-3 pb-xl-0"></div>
                                                    <h4 class="mb-xxl-2 ">
                                                        <a href="#" class="h4" style={h4} >Maths - Introduction</a>
                                                    </h4>
                                                    <div class=" h4">
                                                        <p style={{color:'#A32926'}}>1:47</p>
                                                    </div>
                                    ...
                                    <div class="product-card product-card_style8 hover-container" >
                                        <div class="product-card-wrapper mb-xl-3"  >
                                            <div class="row  p-3" style={{backgroundColor: '#fff', borderRadius:'20px'}}>
                                                ...
                                                <div style={pcInfo}  lass="pc__info position-relative col-lg-6" >
                                                    <div class="mb-3 mb-xl-3 pb-xl-0"></div>
                                                    <h4 class="mb-xxl-2 ">
                                                        <a href="#" class="h4" style={h4} >Maths - Introduction</a>
                                                    </h4>
