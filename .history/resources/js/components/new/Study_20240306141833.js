                ...
                <div className='row'>
                    <div className='col-lg-12 order-lg-1'>
                        <div class="btn-group">
                            ...
                            <a class="th-bt " onClick={handlearden} style={{cursor:'pointer'}}>
                                Arden University <i class="fa fa-arrow-right me"></i>
                            </a>
                            &nbsp;&nbsp;
                            <a class="th-btn style8" onClick={handlearden} style={{cursor:'pointer'}}>
                                London Graduate School <i class="fa fa-arrow-right me"></i>
                            </a>
                            &nbsp;&nbsp;
                            <a class="th-btn style4" onClick={handlearden} style={{cursor:'pointer'}}>
                                eie Institute of Education <i class="fa fa-arrow-right me"></i>
                            </a>
                            &nbsp;&nbsp;
                            <a class="th-btn style5" onClick={handlearden} style={{cursor:'pointer'}}>
                                qualifi approved centre <i class="fa fa-arrow-right me"></i>
                            </a>
                            &nbsp;&nbsp;
                            <a class="th-btn" onClick={handlearden} style={{cursor:'pointer'}}>
                                Aston University <i class="fa fa-arrow-right me"></i>
                            </a>
                            &nbsp;&nbsp;
                            {/* &nbsp;&nbsp; */}
                            <a class="th-btn" onClick={handlearden} style={{cursor:'pointer'}}>
                                 Universidad Católica San Antonio de Murcia <i class="fa fa-arrow-right me"></i>
                            </a>
                            &nbsp;&nbsp;
                            <a class="th-btn" onClick={handlearden} style={{cursor:'pointer'}}>
                                University of Gloucestershire <i class="fa fa-arrow-right me"></i>
                            </a>
                            
                            {/* &nbsp;&nbsp;
                            <a class="th-btn" onClick={handlearden} style={{cursor:'pointer'}}>
                                University College Birmingham <i class="fa fa-arrow-right me"></i>
                            </a> */}
                        </div>
                    </div>
                              ...
                              <div class="accordion" id="accordionExample">
                                ...
                                <div class="accordion-item">
                                    ...
                                    <div class="accordion-body" style={{ textAlign: 'justify' }}>
                                        ...
                                        best institutions for their chosen field of study across the globe. Hence, students do not have to limit themselves to their home country, 
                ...
                <div class="row justify-content-end">
                    <div class="col-xl-6">
                        ...
                        <form class="course-form mb-2" action="#" method='POST'>
                            ...
                            <buttom type="submit" class="th-btn style3">
