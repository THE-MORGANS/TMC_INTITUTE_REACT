  ...
  const imgStyle = {
    ...
    >
      ...
      <div className="swiper-wrapper">
        {/* Replace the image source with your actual paths */}
        <div className="swiper-slide">
          <div className="overflow-hidden position-relative h-100">
            <div className="slideshow-bg">
              <img
                loading="lazy"
                src="../images/home/demo9/slider1.jpg"
                width="1863"
                height="700"
                alt=""
            ...
            {/* Uncomment and modify the following code for slideshow text */}
            {/* <div className="slideshow-text container position-absolute start-50 top-50 translate-middle text-white text-center" style={{ zIndex: 2 }}>
              <h5 className="text_dash text-uppercase fs-base fw-medium animate animate_fade animate_btt animate_delay-3 text-white" style={{ zIndex: 2 }}>Never Stop Learning</h5>
              <h2 className="text-uppercase h1 fw-normal mb-0 animate animate_fade animate_btt animate_delay-5 text-white" style={{ zIndex: 2 }}>TMC INSTITUTE</h2>
              <p className="animate animate_fade animate_btt animate_delay-6 text-white" style={{ zIndex: 2 }}>We Are The Leading And Specialist Provider Of Specialized Corporate Training Including Governance, Risk & Compliance,<br /> Financial Crime Prevention, And Leadership Training Focused On Cultivating The Right Attitude And Skills In Your Teams.</p>
              <a href="#" className="btn-link_sm default-underline text-uppercase fw-medium animate animate_fade animate_btt animate_delay-7">Buy Now</a>
            </div> */}

            {/* Modify the following code for slideshow text */}
            <div className="slideshow-text container position-absolute start-50 top-50 translate-middle text-white text-center w-75" style={{ zIndex: 2 }}>
              <h4 className="text-yellow-bg-rounded text-uppercase fs-base fw-medium animate animate_fade animate_btt animate_delay-3" style={{ fontWeight: 500, color: '#A32926', zIndex: 2 }}> Never Stop Learning</h4>
        ...
        <div className="swiper-slide">
          {/* Modify content for additional slides */}
        </div>
      </div
