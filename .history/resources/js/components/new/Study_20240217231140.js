                        ...
                        <div class="ms-xl-5">
                            ...
                            <div class="mb-10" >
                              ...
                              <div class="accordion" id="accordionExample">
                                ...
                                <div class="accordion-item">
                                    <h2 class="accordion-header">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="true" aria-controls="accordionExample">
                ...
                <div class="row justify-content-end">
                    <div class="col-xl-6">
                        ...
                        <form class="course-form mb-2" action="#">
                            ...
                            <buttom type="buttom" class="th-btn style3">
