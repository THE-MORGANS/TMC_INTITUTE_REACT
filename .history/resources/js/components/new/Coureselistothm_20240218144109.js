                                ...
                                {data.map((item, index)=>{
                                    return <div className="col-md-6 col-xl-4">
                                            ...
                                            <div className="course-box style2" onClick={()=>handleLink(item.id)}>
                                                ...
                                                {item.purchased ? '':
                                                    username?
                                                    <a  onClick={()=>handleCart(item.coursename,  item)} class="th-btn style6 mt-10" style={{cursor:'pointer'}}> {getBtnText(single.id) == 'text-2xl text-green-400'? 'In Cart': 'Add to Cart'} </a> 
                                                    :
                                                    ''
                                                } 
