                        ...
                        <li class="menu-item-has-children">
                            ...
                            <ul class="sub-menu">
                                ...
                                <li class="menu-item-has-children">
                                    ...
                                    <ul class="sub-menu">
                                        <a onClick={handleLG} style={{cursor:'pointer'}}>LGCA</a>
                                        <a onClick={(e)=>handleOthm(e)}  style={{cursor:'pointer'}}>OTHM </a>
                                        <a onClick={(e)=>handleGRC(e)} >Governance, Risk Management, Compliance & Fincrime Prevention</a>
                                    </ul>
                                </li>
                            </ul>
                        </li>
