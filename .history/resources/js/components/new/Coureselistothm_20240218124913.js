                        ...
                        <div class="tab-content" id="nav-tabContent">
                            ...
                            <div class="course-single-bottom">
                                <ul class="nav course-tab" id="courseTab" role="tablist">
                                    ...
                                    {Post.map((item, index)=>{
                                        return <li class="nav-item" role="presentation">
                                            <a class="nav-link active" id="description-tab" data-bs-toggle="tab" href={()=>handlemouse(index, item)} role="tab" aria-controls="Coursedescription" aria-selected="true">
                                ...
                                <div class="tab-content" id="productTabContent">
                                    {data.map((item, index)=>{
                                    return <div class="tab-pane fade show active" id="Coursedescription" role="tabpanel" aria-labelledby="description-tab">
