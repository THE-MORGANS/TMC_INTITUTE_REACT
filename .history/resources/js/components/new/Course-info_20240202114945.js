                        ...
                        <div class="course-single-bottom">
                            <ul class="nav course-tab" id="courseTab" role="tablist">
                                ...
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link" id="curriculam-tab" data-bs-toggle="tab" href="#curriculum" role="tab" aria-controls="curriculum" aria-selected="false">
                            ...
                            <div class="tab-content" id="productTabContent">
                                ...
                                >
                                    ...
                                    <p class="mb-30">
                                        ...
                                        generators on the Internet tend to repeat that
                                    ...
                                    <div class="checklist mb-1">
                                        <ul>
                                        <li>
                                            How to use social media to reach local, national and
                                        ...
                                        <li>
                                            How to create and run online shows, adapt your
                                            performance techniques and
                                        </li>
                                        <li>
                                            Mentoring and troubleshooting and post-training
                                            support from Jason
                                        </li>
                                        <li>
                                            How to use social media to reach local, national and
                                        ...
                                        <li>
                                            Adapt your performance techniques and manage your
                                            audience throughout
                                        </li>
                                        </ul>
                                    </div>
