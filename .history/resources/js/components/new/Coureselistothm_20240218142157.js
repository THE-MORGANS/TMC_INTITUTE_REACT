                                    ...
                                    return <div className="col-md-6 col-xl-4">
                                            ...
                                            <div className="course-box style2" onClick={()=>handleLink(item.id)}>
                                                ...
                                                <div class="course-content">
                                                    ...
                                                    <h3 class="course-title onClick={()=>handleLink(item.id)}">
                                                        <a onClick={()=>handleLink(item.id)}>{item.coursename}</a>
                                                    </h3>
                                                </div>
                                                ...
                                                <div className="card-body p-4">
                                                    <div className="font-semibold line-clamp-2 onClick={()=>handleLink(item.id)}" onClick={()=>handleLink(item.id)}>{item.coursename}
                                                    </div>
                                                    {/* { item.purchased?'': */}

                                                    { item.purchased?'':username?<div className="flex space-x-2 items-center text-sm pt-3">
                                                                    <div className="flex flex-row items-center" onClick={()=>handleCart(item.coursename,  item)}>    
                                                                    {getBtnText(item.coursename) == 'text-2xl text-green-400' ? <h2 className='text-sm capitalize'>In Cart</h2>:<h2 className='text-sm capitalize'>Add to Cart</h2> }
                                                                                <AiOutlineShopping  className={getBtnText(item.coursename)} /> 
                                                                    </div>
                                                                    <div>·</div>
