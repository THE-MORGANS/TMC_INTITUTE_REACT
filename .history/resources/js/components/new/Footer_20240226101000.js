        ...
        <div class="footer-top">
                    ...
                    <div class="footer-contact-wrap">
                        <div class="footer-contact">
                            ...
                            <div class="media-body">
                                ...
                                <a href="tel+11234567890" class="footer-contact_link">+234 (1) 700-1770, +234 (0) 915-341-4314</a>
                            </div>
                        </div>
                        ...
                        <div class="footer-contact">
                            ...
                            <div class="media-body">
                                ...
                                <a href="mailto:enquiries@tmcinstitute.com" class="footer-contact_link">ienquiries@tmcinstitute.com</a>
                            </div>
                        </div>
                        <div class="divider"></div>
                        <div class="footer-contact">
                ...
                <div className="footer-top">
                    <div className="container">
                        <div className="row ">
                            <div class="footer-contact-wrap d-flex justify-content-between ">
                                <div class="col-12 col-xl-6 mb-3">
                                    <div class="footer-contact">
                                        <div class="footer-contact_icon icon-btn"><i class="fal fa-phone"></i></div>
                                        <div class="media-body">
                                            <p class="footer-contact_text">Call us any time:</p>
                                            <a href="tel:+234915-341-4314" class="footer-contact_link"></a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12 col-xl-6 mb-3">
