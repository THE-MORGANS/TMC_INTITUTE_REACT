            ...
            <div class="container">
                <div class="row align-items-center justify-content-between">
                    <div class="col-lg-12"><div class="cta-wrap title-area mb-0">
                        ...
                        <a onClick={(e)=>handleContact(e)} style={{cursor:'ponter'}}  class="th-btn style8 cursor-pointer">Join With Us<i class="fas fa-arrow-right ms-1"></i></a>
                    </div>
                </div>
            </div>
          </div>
                        ...
                        <div className="row justify-content-between">
                            ...
                            <div className="col-md-6 col-xl-auto">
                                <div className="widget widget_nav_menu footer-widget">
                                    ...
                                    <div className="menu-all-pages-container">
                                        <ul className="menu">
                                            <li><a onClick={handlehome}  style={{cursor:'pointer', color:'white'}}>TMC</a></li>
