          ...
          <div className="header-mobile header_sticky">
            <div className="container d-flex align-items-center h-100">
              <a className="mobile-nav-activator d-block position-relative" href="#">
                <svg className="nav-icon" width="25" height="18" viewBox="0 0 25 18" xmlns="http://www.w3.org/2000/svg"><use href="#icon_nav" /></svg>
                <button className="btn-close-lg position-absolute top-0 start-0 w-100"></button>
              </a>
              ...
              <nav className="header-mobile__navigation navigation d-flex flex-column w-100 position-absolute top-100 bg-body overflow-auto">
                <div className="container">
                  <form action="#" method="GET" className="search-field position-relative mt-4 mb-3">
                    <div className="position-relative">
                      <input className="search-field__input w-100 border rounded-1" type="text" name="search-keyword" placeholder="Search products" />
                  ...
                  <div className="overflow-hidden">
                    <ul className="navigation__list list-unstyled position-relative">
                      ...
                      <li className="navigation__item">
                        <a href="#" className="navigation__link js-nav-right d-flex align-items-center">Programs<svg className="ms-auto" width="7" height="11" viewBox="0 0 7 11" xmlns="http://www.w3.org/2000/svg"><use href="#icon_next_sm" /></svg></a>
                        <div className="sub-menu position-absolute top-0 start-100 w-100 d-none">
                          <a href="#" className="navigation__link js-nav-left d-flex align-items-center border-bottom mb-3"><svg className="me-2" width="7" height="11" viewBox="0 0 7 11" xmlns="http://www.w3.org/2000/svg"><use href="#icon_prev_sm" /></svg>Academic</a>
                          <div className="sub-menu__wrapper">
                            <a href="#" className="navigation__link js-nav-right d-flex align-items-center">Academic<svg className="ms-auto" width="7" height="11" viewBox="0 0 7 11" xmlns="http://www.w3.org/2000/svg"><use href="#icon_next_sm" /></svg></a>
                            <div className="sub-menu__wrapper position-absolute top-0 start-100 w-100 d-none">
                              <a href="#" className="navigation__link js-nav-left d-flex align-items-center border-bottom mb-2"><svg className="me-2" width="7" height="11" viewBox="0 0 7 11" xmlns="http://www.w3.org/2000/svg"><use href="#icon_prev_sm" /></svg>Academic List</a>
                            ...
                            <a href="#" className="navigation__link js-nav-right d-flex align-items-center">Professional<svg className="ms-auto" width="7" height="11" viewBox="0 0 7 11" xmlns="http://www.w3.org/2000/svg"><use href="#icon_next_sm" /></svg>Professional</a>
                            <div className="sub-menu__wrapper position-absolute top-0 start-100 w-100 d-none">
                              <a href="#" className="navigation__link js-nav-left d-flex align-items-center border-bottom mb-2"><svg className="me-2" width="7" height="11" viewBox="0 0 7 11" xmlns="http://www.w3.org/2000/svg"><use href="#icon_prev_sm" /></svg>Professional</a>
                              <ul className="sub-menu__list list-unstyled">
                      ...
                      <li className="navigation__item">
                        <a href="#" className="navigation__link">Study Abroad</a>
                      </li>

                      <li className="navigation__item">
                        <a href="./about.html" className="navigation__link js-nav-right d-flex align-items-center">About us<svg className="ms-auto" width="7" height="11" viewBox="0 0 7 11" xmlns="http://www.w3.org/2000/svg"><use href="#icon_next_sm" /></svg></a>
                        <div className="sub-menu position-absolute top-0 start-100 w-100 d-none">
                          <a href="./about.html" className="navigation__link js-nav-left d-flex align-items-center border-bottom mb-2"><svg className="me-2" width="7" height="11" viewBox="0 0 7 11" xmlns="http://www.w3.org/2000/svg"><use href="#icon_prev_sm" /></svg>About us</a>
                ...
                <div className="border-top mt-auto pb-2">
                  <div className="customer-links container mt-4 mb-2 pb-1">
                    <svg className="d-inline-block align-middle" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"><use href="#icon_user" /></svg>
                  ...
                  <ul className="container social-links list-unstyled d-flex flex-wrap mb-0">
                    <li>
                      <a href="#" className="footer__social-link d-block ps-0">
            ...
            <div class="header-mobile header_sticky">
                ...
                <div class="logo">
                    <a href="/">
                    <img src="{{ asset('/images/logo.png')}}" alt="TMC | Institute" class="logo__image d-block" />
                    </a>
                </div>
            ...
            <header id="header" className="header header-fullwidth ">
                ...
                <Routes>
                    <Route path="/studyabroad" component={Study} />
...
{/* <style>
  ...
  .slideshow-bg::before {
    ...
    width: 100%;
    height: 100%;
    background-color: rgba(36, 16, 16, 0.5); 
    z-index: 1;
  }
  .slideshow-text {
    color: white;
