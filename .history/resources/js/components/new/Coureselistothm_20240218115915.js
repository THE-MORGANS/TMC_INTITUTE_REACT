                        ...
                        <div class="tab-content" id="nav-tabContent">
                            ...
                            <div class="tab-pane fade active show" id="tab-list" role="tabpanel" aria-labelledby="tab-shop-list">
                                <div class="course-single-bottom">
                                    ...
                                    {Post.map((item, index)=>{
                                     return <li className={hover == index?"nav-item active tip":"tip"}  role="presentation" key={index} onMouseLeave={()=>handleLeave()} onMouseOver={()=>handleOver(index)} onClick={()=>handlemouse(index, item)}>
                                    ...
                                    //  <li className={hover == index?"active tip":"tip"} >
