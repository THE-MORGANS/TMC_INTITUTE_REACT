                        ...
                        <div class="widget widget_search">
                            ...
                            <div class="widget widget_time_duration style2">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <input id="timecheck3" checked={orderbystat === 's,t,u,v,w,x'} name="alpha" data-name="s,t,u,v,w,x" onChange={(e)=>handleAlphabetical(e)} type="checkbox"/>
                                        <label for="timecheck3">
                                            S-X <span class="checkmark"></span>
                                        </label>
                                    </li>
                                    <li>
                                        <input id="timecheck3" checked={orderbystat === 'data-name="y,z"'} name="alpha" data-name="s,t,u,v,w,x" onChange={(e)=>handleAlphabetical(e)} type="checkbox"/>
                                        <label for="timecheck3">
