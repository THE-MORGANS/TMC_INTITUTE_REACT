...
//  let dataa = localStorage.getItem('Cart')?JSON.parse(localStorage.getItem('Cart')):[]
 useEffect(()=>{
   ...
   const handleRead =()=>{
    ...
    const handlePag = (selectedPage) => {
        setCurrentPage(selectedPage);
        // Implement your logic for handling page change here
    };
    ...
    for (let i = 1; i <= numberofpages; i++) {
        pages.push(
            <li key={i}>
                <a href="blog.html" onClick={() => handlePag(i)}>{i}</a>
            </li>
        );
    }
                                             ...
                                             <div className="th-pagination text-center pt-50">
                                                <ul>
                                                    ...
                                                    {currentPage < numberofpages && (
                                                        <li>
                                                            <a href="blog.html" onClick={() => handlePag(currentPage + 1)}>
