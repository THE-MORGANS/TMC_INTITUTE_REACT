                        ...
                        <div class="tab-content" id="nav-tabContent">
                            ...
                            <div class="tab-pane fade active show" id="tab-list" role="tabpanel" aria-labelledby="tab-shop-list">
                                <div class="course-single-bottom">
                                    ...
                                    {Post.map((item, index)=>{
                                     return<li className={hover == index?"active tip":"tip"} >
                                     ...
                                     <li className={hover == index?"nav-item active tip":"tip"}  role="presentation" key={index} onMouseLeave={()=>handleLeave()} onMouseOver={()=>handleOver(index)} onClick={()=>handlemouse(index, item)}>
                                        <a class="nav-link active" className={overon == index?"top-[-18px] absolute w-100 text-sm bg-[#A32926]  text-white":'hidden'} id="description-tab" data-bs-toggle="tab" href="#Coursedescription" role="tab" aria-controls="Coursedescription" aria-selected="true">
