                                                            ...
                                                            <li>
                                                                ...
                                                                <a href=''>
                                                                    <div className='row' style={{ color:'#333'}}>
                                                                        <div className='col-2'>
                                                                            <img width={120} height={40}  src="https://snatikabucket.s3.ap-southeast-1.amazonaws.com/uploads/manage-cms/universities-image/651bc9aa000fd_universities_image" alt="Image" class="img-responsive"/>
                                                                        </div>
                                                                        <div className='col-10' style={{marginLeft: '-20px', marginTop:'-5px'}}>
