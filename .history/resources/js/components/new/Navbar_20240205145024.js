                                        ...
                                        {username ?
                                            <>
                                                <li class="d-none d-lg-inline-block">
                                                    <i class="far fa-user"></i><a href="" class="sideMenuToggler">Welcome, {username}</a>
                                                </li>
                                                {/* Additional elements for authenticated user if needed */}
                                            </>
                                            :
                                            <>
                                                <li class="d-none d-lg-inline-block">
                                                ...
                                                <li class="d-none d-lg-inline-block">
                                                    <i class="far fa-user"></i><a onClick={(e)=>handlecompanyregister(e)} class="sideMenuToggler">Coroperate</a>
                                                </li>
                                            </>
                                        }
