        ...
        <main>
          ...
          <section class="shop-checkout container">
            ...
            <div class="checkout-steps">
              ...
              <a onClick={(e)=>handleCheckout(e)} class="checkout-steps__item">
                ...
                <table class="cart-table">
                  ...
                  <tbody>
                    <tr>
                      <td>
                        <div class="shopping-cart__product-item">
                          <img loading="lazy" src="../images/courses/course-1.png" width="120" height="120" alt="" />
                        </div>
                      </td>
                      <td>
                        <div class="shopping-cart__product-item__detail">
                          <h4>Regulatory Risk Management Training</h4>
                        </div>
                      </td>
                      <td>
                    ...
                    <tr>
                      <td>
                        <div class="shopping-cart__product-item">
                          <img loading="lazy" src="../images/courses/course-2.png" width="120" height="120" alt="" />
                        </div>
                      </td>
                      <td>
                        <div class="shopping-cart__product-item__detail">
                    ...
                    <tr>
                      <td>
                        <div class="shopping-cart__product-item">
                          <img loading="lazy" src="../images/courses/course-3.png" width="120" height="120" alt="" />
                        </div>
                      </td>
                      <td>
                        <div class="shopping-cart__product-item__detail">
...
if(document.getElementById('cart')){
  ReactDOM.render(<Checkout/>, document.getElementById('cart'))
}
