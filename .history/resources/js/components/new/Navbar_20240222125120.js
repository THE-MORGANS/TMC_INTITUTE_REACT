                                    ...
                                    <ul>
                                        <li>
                                            <div class="header-social">
                                                ...
                                                <a href="https://www.facebook.com/"><i class="fab fa-facebook-f"></i></a> <a href="https://www.twitter.com/"><i class="fab fa-twitter"></i></a> <a href="https://www.linkedin.com/"><i class="fab fa-linkedin-in"></i></a> <a href="https://www.youtube.com/"><i class="fab fa-youtube"></i></a> <a href="https://www.instagram.com/"><i class="fab fa-skype"></i></a>
                                            </div>
                                        </li>
                                        ...
                                        {/* <div class="col-auto d-none d-xl-block d-none d-lg-inline-block">
                                            <div class="header-button">
                                                ...
                                                {username ? (
                                                    ...
                                                    <>
                                                        <a style={{cursor:'pointer'}} onClick={(e) => handlesignup(e)} className="th-btn wc-forward">
                                                            <FaUserAlt/> Individual
                                                        </a>{" "}
                                                        <a  style={{cursor:'pointer'}} onClick={(e) => handlecompanyregister(e)} className="th-btn checkout wc-forward">
                                                            <BsBuilding/> Corporate
                                                        </a>
                                                    </>
                                                )}
