  ...
  return (
    <div>
      ...
      <div class="th-checkout-wrapper space-top space-extra-bottom">
            <div class="container">
            <button type="submit" class="th-btn" data-name="Logout" onClick={(e)=>handleLinks(e)}> Back Home</button>
                ...
                <form action="#" class="woocommerce-checkout mt-40">
                    ...
                    <div class="form-row place-order">
                      ...
                      :
                        <button type="submit" class="th-btn" onClick={handleback}> Back Home</button>
                      }
