                ...
                <div class="col-xxl-3 col-lg-4">
                    <aside class="sidebar-area">
                        <div class="widget widget_info">
                            ...
                            <a onClick={()=>handleLearn(single.id)} style={{cursor:'pointer'}} class="th-btn style6 mt-35 mb-0">Start Learning</a>
                            <a onClick={handleEnrolCom} style={{cursor:'pointer'}} class="th-btn">Enrol as a Company</a>
                            <a href="cart.html" style={{cursor:'pointer'}} class="th-btn style4">Enrol as a Student</a>
                        </div>
                        </aside>
                    </div>
                </div>
