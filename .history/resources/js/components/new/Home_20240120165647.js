...
export default function Home() {
    ...
    const handledetailscourses = ()=>{
        window.location.href = ` ${url}/coursesdetails`
    }
          ...
          <section className="products-carousel container">
              ...
              <div className="tab-pane fade show active" id="collections-tab-1" role="tabpanel" aria-labelledby="collections-tab-1-trigger">
                    ...
                    <div className="col-6 col-md-4 col-lg-3">
                      <div className="product-card mb-3 mb-md-4 mb-xxl-5">
                        ...
                        <div className="pc__info position-relative text-center ">
                          ...
                          <a  onClick={(e)=>handleViewcourses(e)}  className="mt-xl-4 mb-xl-4 btn btn-outline-primary" style={{borderRadius: '10px'}}>Class Details</a>
                  ...
                  <div className="text-center mt-2">
                    <a  onClick={(e)=>handledetailscourses(e)}  className="mt-xl-4 mb-xl-4 btn btn-primary" style={{bordeRadius: '10px'}}>View More Courses</a>
                  </div>
              </div>
          </section>
