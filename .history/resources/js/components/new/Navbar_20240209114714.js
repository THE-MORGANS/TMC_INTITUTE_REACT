                    ...
                    <div className="th-mobile-menu">
                        ...
                        <li class="menu-item-has-children">
                            ...
                            <li class="menu-item-has-children">
                                ...
                                <ul class="sub-menu">
                                    <li onClick={(e)=>handleMission(e)} ><a href="">Mission</a></li>
                                    <li onClick={(e)=>handleAboutus(e)} ><a href="">Our Team</a></li>
                                    <li onClick={(e)=>handleAboutus(e)} ><a href="">Recognition</a></li>
                                    <li onClick={(e)=>handleAboutus(e)} ><a href="">Our Partiners</a></li>
                                </ul>
                            </li>
                                ...
                                <div class="header-links header-right">
                                    <ul>
                                        ...
                                        {username ?
                                            ...
                                            <>
                                                <li class="d-none d-lg-inline-block">
                                                <i class="far fa-user"></i> {''}<a onClick={(e)=>handlesignup(e)} class="" >Individual</a>
                                                </li>
                                                <li class="d-none d-lg-inline-block">
                                                    <BsBuilding/><a onClick={(e)=>handlecompanyregister(e)} class="">Coroperate</a>
                                                </li>
                                            </>
                                        }
                                            ...
                                            <nav class="main-menu d-none d-lg-inline-block">
                                                <ul>
                                                    ...
                                                    <li class="menu-item-has-children">
                                                        <a onClick={(e)=>handleAboutus(e)} >About us</a>
                                                        <ul class="sub-menu">
                                                            <li><a onClick={(e)=>handleMission(e)}>Mission</a></li>
                                                            <li><a onClick={(e)=>handleMission(e)}>Our Team</a></li>
                                                            <li><a onClick={(e)=>handleMission(e)}>Recognition</a></li>
                                                            <li><a onClick={(e)=>handleMission(e)}>Our Partiners</a></li>
                                                        </ul>
                                                    </li>
                                                    <li><a onClick={(e)=>handleHowtoAppy(e)}>How to Apply</a></li>
                                        ...
                                        <div class="col-auto d-none d-xl-block d-none d-lg-inline-block">
                                            <div class="header-button">
                                                <button type="button" class="icon-btn searchBoxToggler"><i class="far fa-search"></i></button> 
                                                 ...
                                                 {
                                                    username? <a onClick={(e) => handleCart(e)} className="icon-btn ">
                                                        <i className="far fa-shopping-cart"></i> <span className="badge">{Cart.length}</span>
                                                        </a> :''
                                                }

                                                {username ? (
                                                    <a onClick={(e) => handlesignup(e)}>
                                                ...
                                                <div class="category-menu-wrap">
                                                    ...
                                                    <nav class="category-menu">
                                                        <ul>
                                                            ...
                                                            <li>
                                                                <a honClick={handleLogout} style={{cursor:'pointer'}}> Log Out </a>
                                                            </li>
                                                        </ul>
                                                    </nav>
                                                </div>
