    ...
    <div className="card uk-transition-toggle">
        ...
        <div className="card-body p-4">
            ...
            { item.purchased?'':username?
                               ...
                               <div className="flex flex-row items-center" onClick={()=>handleCart(item.id)}>  
            ...
            <div className="pt-1 flex items-center justify-between">
                ...
                {/* <div className="text-lg font-semibold"><Naira>{item.price}</Naira></div> */}
                  <div className='text-lg font-semibold'>
                     <CurrencyFormat value={moneyTalks(item.converted, item.price, item.currency_name)} displayType={'text'} thousandSeparator={true} prefix={symbol} /> </div>
            </div>
        </div>
    </div>
</a>
