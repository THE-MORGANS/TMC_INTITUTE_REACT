                                                        ...
                                                        <li>
                                                            ...
                                                            <li>
                                                                ...
                                                                <a href=''>
                                                                    <div className='row justify-content-center' style={{ color:'#333'}}>
                                                                        <div className='col-2'>
                                                                            <img width={120} height={30} src="https://snatikabucket.s3.ap-southeast-1.amazonaws.com/uploads/manage-cms/universities-image/651bc96eba4c2_universities_image" alt="Image" class="img-responsive"/>
                                                                        </div>
                                                                        <div className='col-10' style={{marginLeft: '-20px', marginTop:'-5px'}}>
