...
export default function Home()  {
  let url = window.location.origin;
    ...
    { id: 1, title: 'Featured Course 1', description: 'Description for Featured Course 1' },
    { id: 2, title: 'Featured Course 2', description: 'Description for Featured Course 2' },
    // ... more data ...
  ];
       ...
       <Navbar />
        <main class="bg-grey-faf9f8">
          ...
          <section className="products-carousel container">
              ...
              <p>pp</p>
              {/* Featured Content */}
              <FeaturedContent featured={featuredData} />
