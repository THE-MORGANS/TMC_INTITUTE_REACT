                ...
                <div class="col-xxl-3 col-lg-4">
                    <aside class="sidebar-area">
                        <div class="widget widget_info">
                            ...
                            {/* // Ensure single is not null before accessing its id property
{single && single.id && (
    <p className={getBtnText(single.id)}>{getBtnText(single.id)}</p>
)} */}

<p key={id} className={getBtnText(id)}>Item {id}: {getBtnText(id)}</p>
