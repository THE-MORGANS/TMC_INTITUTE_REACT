   ...
   // Logic to get current posts
    ...
    const handleLink =(word, id)=>{
     ...
     const handleCourseClick = (courseId) => {
        // Add logic to get course details or navigate to a detailed view
                     ...
                     <div class="tab-pane fade active show" id="tab-grid" role="tabpanel" aria-labelledby="tab-course-grid">
                        ...
                        {currentPosts.map(item => (
                            <div class="col-md-6 col-lg-4 col-xxl-3 filter-item cat1 cat3">
                                <a  key={course.id} onClick={()=>handleLink('TMC', item.id)} style={{ cursor: 'pointer' }}>
                                <div class="course-box2 style2">
                                    ...
                                    <div class="course-content">
                                        <div class="course-author">
                                                ...
                                                <a  key={course.id} onClick={()=>handleLink('TMC', item.id)} class="author-name" style={{ cursor: 'pointer' }}>
                                        ...
                                        <h4 class="course-title">
                                            <a  key={course.id} onClick={()=>handleLink('TMC', item.id)} style={{ cursor: 'pointer' }}> {item.coursename.substring(0, 30)+'...'} </a>
                                        </h4>
