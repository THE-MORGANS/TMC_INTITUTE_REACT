...
function Coursedetails() {
  ...
  return (
    <div>
        ...
        <main style={{background-color: '#F7F5FA'}}>
            <section class="shop-main container border-top-1 p-4" style={{background-color: '#EFEBF5', borderRadius:'20px'}}>
                <div class="container">
                            ...
                            <div class="product-card product-card_style8 hover-container" >
                                ...
                                <div class="product-card product-card_style8 hover-container" >
                                    <div class="product-card-wrapper mb-xl-3"  >
                                        <div class="row  p-3" style="background-color: #fff; border-radius:20px;">
                                            <div class="blog-list__item-image col-lg-6" >
                                            <img style="border-radius: 10px;" loading="lazy"  class="h-auto" src="../images/courses/course-3.png" width="680" height="493" alt="" />
                                            </div>
                                ...
                                <div class="product-card product-card_style8 hover-container" >
                                    <div class="product-card-wrapper mb-xl-3"  >
                                        <div class="row  p-3" style="background-color: #fff; border-radius:20px;">
                                            <div class="blog-list__item-image col-lg-6" >
                                            <img style="border-radius: 10px;" loading="lazy"  class="h-auto" src="../images/courses/course-4.png" width="680" height="493" alt="" />
                                            </div>
                                ...
                                <div class="product-card product-card_style8 hover-container" >
                                    <div class="product-card-wrapper mb-xl-3"  >
                                        <div class="row  p-3" style="background-color: #fff; border-radius:20px;">
                                            <div class="blog-list__item-image col-lg-6" >
                                            <img style="border-radius: 10px;" loading="lazy"  class="h-auto" src="../images/courses/course-5.jpeg" width="680" height="493" alt="" />
                                            </div>
                                ...
                                <div class="product-card product-card_style8 hover-container" >
                                    <div class="product-card-wrapper mb-xl-3"  >
                                        <div class="row  p-3" style="background-color: #fff; border-radius:20px;">
                                            <div class="blog-list__item-image col-lg-6" >
                                            <img style="border-radius: 10px;" loading="lazy"  class="h-auto" src="../images/courses/course-6.jpeg" width="680" height="493" alt="" />
                                            </div>
