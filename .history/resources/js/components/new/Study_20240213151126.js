                        ...
                        <div class="ms-xl-5">
                            ...
                            <div class="mb-10" >
                              ...
                              <div class="accordion" id="accordionExample">
                                ...
                                <div class="accordion-item">
                                    <h2 class="accordion-header">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTenOne" aria-expanded="false" aria-controls="collapseThree">
            ...
            <div class="container space z-index-common">
                <div class="row justify-content-end">
                    <div class="col-xl-6">
                        ...
                        <p class="mb-30 text-light">Quality technologies via fully tested methods of empowerment. Proactively disseminate web enabled best practices after cross functional expertise.</p>
                        <form class="course-form mb-2" action="#">
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <input type="text" name="number" id="number" placeholder="Inspection Date*" />
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                        ...
                        <a href="course.html" class="th-btn style3">
