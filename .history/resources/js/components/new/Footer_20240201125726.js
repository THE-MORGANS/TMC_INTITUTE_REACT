                            ...
                            <div className="col-md-6 col-xl-auto">
                                <div className="widget widget_nav_menu footer-widget">
                                    ...
                                    <div className="menu-all-pages-container">
                                        <ul className="menu">
                                            <li><a href="course.html">Cooperate governance</a></li>
                                            <li><a href="course.html">Financial crime prevention</a></li>
                                            <li><a href="course.html">Insurance courses</a></li>
                                            <li><a href="course.html">Development</a></li>
                                            <li><a href="course.html">Risk management</a></li>
