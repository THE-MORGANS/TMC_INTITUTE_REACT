    ...
    <div class="footer-middle container">
      <div class="row row-cols-lg-5 row-cols-2">
        ...
        <div class="footer-column footer-menu mb-4 mb-lg-0">
          ...
          <ul class="sub-menu__list list-unstyled">
            <li class="sub-menu__item"><a href="#" className="menu-link menu-link_us-s">Press</a></li>
            <li class="sub-menu__item"><a href="#" className="menu-link menu-link_us-s">Investors</a></li>
            <li class="sub-menu__item"><a href="terms.html" className="menu-link menu-link_us-s">Terms</a></li>
