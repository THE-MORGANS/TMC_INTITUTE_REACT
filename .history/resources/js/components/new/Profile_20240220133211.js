                ...
                <form action="#" class="woocommerce-checkout mt-40">
                    ...
                    <div class="form-row place-order">
                      ...
                      {additional != null?
                        ...
                        <a className='d-md sm:text-sm sm:text-white  md:bg-[#A32926] md:py-3 md:w-44 md:px-2 md:rounded-md md:text-sm md:text-white lg:bg-[#A32926] lg:py-3 lg:px-2 lg:rounded-md lg:text-sm lg:text-white' data-name="edit" onClick={(e)=>handleClick(e)}>
                        Edit profile
                        </a>
                      :
