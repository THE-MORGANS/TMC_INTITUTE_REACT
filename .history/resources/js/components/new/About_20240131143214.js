...
export default function About() {
    ...
    return (
      ...
      <div className="container">
        ...
        <div className="row th-carousel slider-shadow" data-slide-show="4" data-lg-slide-show="3" data-md-slide-show="2" data-sm-slide-show="2" data-xs-slide-show="1">
            ...
            <div className="team-card style2">
              <div className="team-img-wrap">
                <svg className="team-shape" xmlns="http://www.w3.org/2000/svg" width="327" height="337" viewBox="0 0 327 337" fill="none">
                  {/* Include the SVG path here */}
                </svg>
                <div className="team-img"><img src="assets/img/team/team_2_1.jpg" alt="Team" /></div>
              ...
              <div className="team-content">
                <h3 className="team-title"><a href="team-details.html">Hirmar Ubunti</a></h3>
                <span className="team-desig">Instructor</span>
              </div>
            </div>
          </div>
          {/* Repeat the above code block for each team member */}
        </div>
      </div>
    </section>
