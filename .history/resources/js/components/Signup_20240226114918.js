  ...
  <article className='w-3/4 flex flex-col items-center mt-4'>
             ...
             <div class="form-group">
                {/* <input type="checkbox" onChange={(e)=>Setterms(e.target.checked)} value={terms}  style={{width:"20px", height:"20px"}}/> */}
                  <div class="custom-checkbox">
                      <input type="checkbox" checked={terms} value={terms}  onChange={(e)=>Setterms(e.target.checked)}  />
                      <label for="remembermylogin">I agreed to the <snap style={{color:'#A32926'}} onClick={handleterms}>Terms & Conditions</snap></label>
                  </div>
              </div>
             {/* <input type="checkbox" onChange={(e)=>Setterms(e.target.checked)} value={terms}  style={{width:"20px", height:"20px", backgroundColor:'red'}}/>
             ...
             <article className='w-3/4 flex flex-col items-center mt-4'>
                ...
                {loader?'please wait...':'Sign up'}
                 ...
                 <div onClick={(e)=>handleClick(e)} data-name="login"  className=''>
