  ...
  return ( 
    ...
    <article className='w-full px-5'>
     <span className='w-1/4 float-left mt-2'>
         {additional === null?
             <button className='bg-[#A32926] py-3 w-44 px-2 rounded-md text-sm text-white  sm:bg-[#A32926] sm:py-3 sm:w-44 sm:px-2 sm:rounded-md sm:text-sm sm:text-white  md:bg-[#A32926] md:py-3 md:w-44 md:px-2 md:rounded-md md:text-sm md:text-white lg:bg-[#A32926] lg:py-3 lg:px-2 lg:rounded-md lg:text-sm lg:text-white' 
             data-name="edit" onClick={(e)=>handleClick(e)}>
               Edit profile
             </button>
         :
