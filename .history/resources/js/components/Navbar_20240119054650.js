...
function Navbar() {
    return (
        <header id="header" classNameclassNameName="header header-fullwidth ">
        <div className="container">
          <div className="header-desk header-desk_type_1">
            <div className="logo">
              <a href="/">
                <img src="{{ asset('images/logo.png')}}" width="40px" height="40px" alt="TMC | Institute" className="logo__image d-block" />
              </a>
            </div>
            ...
            <nav className="navigation">
                <ul className="navigation__list list-unstyled d-flex">
                    ...
                    <a href="./index.html" className="navigation__link">Programs</a>
