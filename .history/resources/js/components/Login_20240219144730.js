                    ...
                    <div class="col-xxl-7 col-xl-8 align-self-end">
                      <div class="woocommerce-form-login-toggle">
                            <div class="woocommerce-info">
                                Sign up? <a onClick={(e)=>handleClick(e)} data-name="login" class="showlogin cursor-pointer">Do not have an account? Sign up</a>
                            </div>
                        </div>
                        ...
                        <div class="consult-form ajax-contact">
                            ...
                            <div class="row gx-24">
                                ...
                                <div class="form-btn  col-10">
                                    <button className='th-btn cursor-pointer' onClick={(e)=>handleSubmit(e)}>
                                    {   loader?'please wait...':'login'}
                                    </button>
                                    <p class="fs-xs mt-2 mb-0">
                                        <a class="text-reset cursor-pointer" onClick={handleForget}>Do not have an account? Sign up</a>
                                    </p>
                                </div>
