                    ...
                    <div class="col-xxl-7 col-xl-8 align-self-end">
                      <div class="woocommerce-form-login-toggle">
                            <div class="woocommerce-info">
                                Sign up? <a href="#" class="showlogin">Click here to login</a>
                            </div>
                        </div>
                        <form action="mail.php" method="POST" class="consult-form ajax-contact">
                            <div class="row gx-24">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                    <input type={conpass == false?"password":"text"}  placeholder="Comfirm Password" class="form-control" onChange={(e)=>Setpassword_confirmation(e.target.value)} value={password_confirmation} />
