...
<html class="no-js" lang="zxx">
    ...
    <body>
                ...
                <div class="widget">
                    ...
                    <div class="recent-post-wrap">
                        <div class="recent-post">
                            <div class="media-img">
                                <a href="blog-details.html">
                                    <img src="img/blog/recent-post-1-1.jpg" alt="Blog Image">
                                </a>
                            </div>
                            <div class="media-body">
                                <h4 class="post-title">
                                    <a class="text-inherit" href="blog-details.html">How To Start Learn Online Study From Your Home</a>
                                </h4>
                        ...
                        <div class="recent-post">
                            <div class="media-img">
                                <a href="blog-details.html">
                                    <img src="img/blog/recent-post-1-2.jpg" alt="Blog Image">
                                </a>
                            </div>
                            <div class="media-body">
                                <h4 class="post-title">
                                    <a class="text-inherit" href="blog-details.html">A Guide for Teachers and Education Staff.</a>
                                </h4>
                                <div class="recent-post-meta">
                                    <a href="blog.html">
                                        <i class="fal fa-calendar"></i>
                        ...
                        <div class="recent-post">
                            <div class="media-img">
                                <a href="blog-details.html">
                                    <img src="img/blog/recent-post-1-3.jpg" alt="Blog Image">
                                </a>
                            </div>
                            <div class="media-body">
                                <h4 class="post-title">
                                    <a class="text-inherit" href="blog-details.html">Educate Empower Excel Discover the Power.</a>
                                </h4>
                                <div class="recent-post-meta">
                                    <a href="blog.html">
                                        <i class="fal fa-calendar"></i>
                ...
                <div class="widget widget_contact">
                    ...
                    <div class="th-widget-contact">
                        <div class="info-box-wrap">
                            ...
                            <p class="info-box_text">147/I, Green Road, Gulshan Avenue, Panthapath, Dhaka</p>
                        </div>
                        <div class="info-box-wrap">
                            <div class="info-box_icon">
        ...
        <div class="breadcumb-wrapper" data-bg-src="img/bg/breadcumb-bg.jpg" data-overlay="title" data-opacity="8">
            <div class="breadcumb-shape" data-bg-src="img/bg/breadcumb_shape_1_1.png"></div>
            <div class="shape-mockup breadcumb-shape2 jump d-lg-block d-none" data-right="30px" data-bottom="30px">
                <img src="img/bg/breadcumb_shape_1_2.png" alt="shape">
            </div>
            <div class="shape-mockup breadcumb-shape3 jump-reverse d-lg-block d-none" data-left="50px" data-bottom="80px">
                <img src="img/bg/breadcumb_shape_1_3.png" alt="shape">
            </div>
            <div class="container">
                            ...
                            <div class="tab-pane fade" id="tab-grid" role="tabpanel" aria-labelledby="tab-shop-grid">
                                <div class="row gy-30">
                                    <div class="col-12">
                                        <div class="course-grid">
                                            <div class="course-img">
                                                <img src="img/course/course_2_1.png" alt="img">
                                                <span class="tag">
                                            ...
                                            <div class="course-content">
                                                ...
                                                <div class="course-author">
                                                    <div class="author-info">
                                                        <img src="img/course/author.png" alt="author">
                                    ...
                                    <div class="col-12">
                                        <div class="course-grid">
                                            <div class="course-img">
                                                <img src="img/course/course_2_2.png" alt="img">
                                                <span class="tag">
                                                    <i class="fas fa-clock"></i>
                                                    02 WEEKS
                                                </span>
                                            ...
                                            <div class="course-content">
                                                ...
                                                <p class="course-text">Through our initiatives, we aim to bridge educational gaps. We are committed to making a positive impact on education globally improve learning outcomes.</p>
                                                <div class="course-meta style2">
                                                    <span>
                                                        <i class="fal fa-file"></i>
                                                        Lesson 9
                                    ...
                                    <div class="col-12">
                                        <div class="course-grid">
                                            <div class="course-img">
                                                <img src="img/course/course_2_3.png" alt="img">
                                                <span class="tag">
                                                    <i class="fas fa-clock"></i>
                                                    04 WEEKS
                                                </span>
                                    ...
                                    <div class="col-12">
                                        <div class="course-grid">
                                            <div class="course-img">
                                                <img src="img/course/course_2_4.png" alt="img">
                                                <span class="tag">
                                                    <i class="fas fa-clock"></i>
                                                    02 WEEKS
                                                </span>
                                    ...
                                    <div class="col-12">
                                        <div class="course-grid">
                                            <div class="course-img">
                                                <img src="img/course/course_2_5.png" alt="img">
                                                <span class="tag">
                                                    <i class="fas fa-clock"></i>
                                                    03 WEEKS
                                                </span>
                                    ...
                                    <div class="col-12">
                                        <div class="course-grid">
                                            <div class="course-img">
                                                <img src="img/course/course_2_6.png" alt="img">
                                                <span class="tag">
                                                    <i class="fas fa-clock"></i>
                                                    02 WEEKS
                                                </span>
                                            ...
                                            <div class="course-content">
                                                ...
                                                <h3 class="course-title">
                                                    <a href="course-details.html">Fashion Photography From To Professional Courses</a>
                                                </h3>
                                                <p class="course-text">We aim to bridge educational gaps, improve learning outcomes. We are committed to making a positive impact on education globally, through our initiatives.</p>
                                                <div class="course-meta style2">
                                                    <span>
                                ...
                                <div class="row gy-30">
                                    <div class="col-md-6 col-xl-4">
                                        <div class="course-box style2">
                                            <div class="course-img">
                                                <img src="img/course/course_1_1.png" alt="img">
                                                <span class="tag">
                                                    <i class="fas fa-clock"></i>
                                                    03 WEEKS
                                                </span>
                                    ...
                                    <div class="col-md-6 col-xl-4">
                                        <div class="course-box style2">
                                            <div class="course-img">
                                                <img src="img/course/course_1_2.png" alt="img">
                                                <span class="tag">
                                                    <i class="fas fa-clock"></i>
                                                    02 WEEKS
                                                </span>
                                    ...
                                    <div class="col-md-6 col-xl-4">
                                        <div class="course-box style2">
                                            <div class="course-img">
                                                <img src="img/course/course_1_3.png" alt="img">
                                                <span class="tag">
                                                    <i class="fas fa-clock"></i>
                                                    04 WEEKS
                                                </span>
                                    ...
                                    <div class="col-md-6 col-xl-4">
                                        <div class="course-box style2">
                                            <div class="course-img">
                                                <img src="img/course/course_1_4.png" alt="img">
                                                <span class="tag">
                                                    <i class="fas fa-clock"></i>
                                                    02 WEEKS
                                                </span>
                                    ...
                                    <div class="col-md-6 col-xl-4">
                                        <div class="course-box style2">
                                            <div class="course-img">
                                                <img src="img/course/course_1_5.png" alt="img">
                                                <span class="tag">
                                                    <i class="fas fa-clock"></i>
                                                    03 WEEKS
                                                </span>
                                    ...
                                    <div class="col-md-6 col-xl-4">
                                        <div class="course-box style2">
                                            <div class="course-img">
                                                <img src="img/course/course_1_6.png" alt="img">
                                                <span class="tag">
                                                    <i class="fas fa-clock"></i>
                                                    02 WEEKS
                                                </span>
                                            ...
                                            <div class="course-content">
                                                ...
                                                <h3 class="course-title">
                                                    <a href="course-details.html">Great Graphical Design That Catches Eyes</a>
                                                </h3>
                                                <div class="course-meta">
                                                    <span>
                                                        <i class="fal fa-file"></i>
                                    ...
                                    <div class="col-md-6 col-xl-4">
                                        <div class="course-box style2">
                                            <div class="course-img">
                                                <img src="img/course/course_1_7.png" alt="img">
                                                <span class="tag">
                                                    <i class="fas fa-clock"></i>
                                                    04 WEEKS
                                                </span>
                                            ...
                                            <div class="course-content">
                                                ...
                                                <h3 class="course-title">
                                                    <a href="course-details.html">Marketing 2023: Complete Guide To Social Growth</a>
                                                </h3>
                                                <div class="course-meta">
                                                    <span>
                                                        <i class="fal fa-file"></i>
                                    ...
                                    <div class="col-md-6 col-xl-4">
                                        <div class="course-box style2">
                                            <div class="course-img">
                                                <img src="img/course/course_1_8.png" alt="img">
                                                <span class="tag">
                                                    <i class="fas fa-clock"></i>
                                                    02 WEEKS
                                                </span>
                                            ...
                                            <div class="course-content">
                                                ...
                                                <h3 class="course-title">
                                                    <a href="course-details.html">The complete business plan course includes 20+ template</a>
                                                </h3>
                                                <div class="course-meta">
                                                    <span>
                                                        <i class="fal fa-file"></i>
                                    ...
                                    <div class="col-md-6 col-xl-4">
                                        <div class="course-box style2">
                                            <div class="course-img">
                                                <img src="img/course/course_1_9.png" alt="img">
                                                <span class="tag">
                                                    <i class="fas fa-clock"></i>
                                                    03 WEEKS
                                                </span>
                                    ...
                                    <div class="col-md-6 col-xl-4">
                                        <div class="course-box style2">
                                            <div class="course-img">
                                                <img src="img/course/course_1_10.png" alt="img">
                                                <span class="tag">
                                                    <i class="fas fa-clock"></i>
                                                    02 WEEKS
                                                </span>
                                    ...
                                    <div class="col-md-6 col-xl-4">
                                        <div class="course-box style2">
                                            <div class="course-img">
                                                <img src="img/course/course_1_11.png" alt="img">
                                                <span class="tag">
                                                    <i class="fas fa-clock"></i>
                                                    04 WEEKS
                                                </span>
                                            ...
                                            <div class="course-content">
                                                ...
                                                <h3 class="course-title">
                                                    <a href="course-details.html">Best Statistics Data Science & Business Analysis</a>
                                                </h3>
                                                <div class="course-meta">
                                                    <span>
                                                        <i class="fal fa-file"></i>
                                    ...
                                    <div class="col-md-6 col-xl-4">
                                        <div class="course-box style2">
                                            <div class="course-img">
                                                <img src="img/course/course_1_12.png" alt="img">
                                                <span class="tag">
                                                    <i class="fas fa-clock"></i>
                                                    02 WEEKS
                                                </span>
                                            ...
                                            <div class="course-content">
                                                ...
                                                <h3 class="course-title">
                                                    <a href="course-details.html">Angular with Nodejs Fullstack Development</a>
                                                </h3>
                                                <div class="course-meta">
                                                    <span>
                                                        <i class="fal fa-file"></i>
        ...
        <footer class="footer-wrapper footer-layout-default" data-bg-src="img/bg/footer-bg.png">
            <div class="shape-mockup footer-shape1 jump" data-left="60px" data-top="70px">
                <img src="img/normal/footer-bg-shape1.png" alt="img">
            </div>
            <div class="shape-mockup footer-shape2 jump-reverse" data-right="80px" data-bottom="120px">
                <img src="img/normal/footer-bg-shape2.png" alt="img">
            </div>
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-3">
                            <div class="footer-logo">
                                <a href="index.html">
                                    <img src="img/logo-white.svg" alt="edura">
                                </a>
                            </div>
                        </div>
                        <div class="col-lg-9">
                        ...
                        <div class="col-md-6 col-xl-auto">
                            <div class="widget widget_nav_menu footer-widget">
                                ...
                                <div class="menu-all-pages-container">
                                    <ul class="menu">
                                        <li>
                                            <a href="course-details.html">Health Course</a>
                                        </li>
                                        <li>
                                            <a href="course-details.html">Web Development</a>
                                        </li>
                                        <li>
                                            <a href="course-details.html">UI/UX Design</a>
                                        </li>
                                        <li>
                                            <a href="course-details.html">Life Style Course</a>
                                        </li>
                                        <li>
