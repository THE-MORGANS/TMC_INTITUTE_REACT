...
class Frontends extends Controller
{
    ...
    return view('newdesign.cousevideo', ["fetchdata"=>$fetchdata, "coursepurshase"=>json_decode($coursepurshase), "coursecomplete"=>$coursecomplete, 'question'=>$question, 'num'=>$num, 'word'=>$word, 'downresult'=>$result, 'greatereight'=>$greatereight, 'toptitle'=>$toptitle ]);
      ...
      public function listcourses($uni, $pagdata, $numberofcourse, $currencysymbol, $currencyex, $additionalpic){
        ...
        return view('newdesign.listcouses',['unihead'=>$uni, 'coursesdata'=>$pagdata, 'currencysymbol'=>$currencysymbol,''=>$numberofcourse 'currencyex'=>$currencyex, 'poundton'=>$poundton, 'othermoney'=>$othermoney, 'toptitle'=>$toptitle, 'additionalpic'=>$additionalpic]);
      }
