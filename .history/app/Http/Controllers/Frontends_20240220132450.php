...
class Frontends extends Controller
{
    ...
    return view('newdesign.cousevideo', ["fetchdata"=>$fetchdata, "coursepurshase"=>json_decode($coursepurshase), "coursecomplete"=>$coursecomplete, 'question'=>$question, 'num'=>$num, 'word'=>$word, 'downresult'=>$result, 'greatereight'=>$greatereight, 'toptitle'=>$toptitle ]);
      ...
      public function conditions(){
        ...
        $page= 1;
        $pagdata =  $this->paginate($data, 6, $page); 
        return view('newdesign.conditions', [ 'coursesdata'=>$pagdata, 'currencysymbol'=>$currencysymbol, 'currencyex'=>$currencyex, 'poundtodollar'=>$poundtodollar, 'poundton'=>$poundton, 'othermoney'=>$othermoney, 'toptitle'=>$toptitle, 'additionalpic'=> $additionalpic]);
       
        // return view('newdesign.conditions', ['coursesdata'=>$pagdata, 'currencysymbol'=>$currencysymbol, 'currencyex'=>$currencyex, 'currencycode'=>$currencycode, 'toptitle'=>$toptitle, 'additionalpic'=>$additionalpic]);
      }
