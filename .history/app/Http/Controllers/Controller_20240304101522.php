...
class Controller extends BaseController
{
   ...
   public function get_client_ip() {
    ...
    public function poundconvert(){
       ...
       $curl = curl_init();
       curl_setopt_array($curl, array(
         CURLOPT_URL => "https://api.fastforex.io/fetch-one?from=$from&to=$to&api_key=d981ef6726-9f514e63f2-s9flno",
    ...
    public function poundtonaira(){
       ...
       $curl = curl_init();
       curl_setopt_array($curl, array(
         CURLOPT_URL => "https://api.fastforex.io/fetch-one?from=$from&to=$to&api_key=bf81ae146a-c60abc61cf-s9flz6",
         CURLOPT_HTTPHEADER => array(
        "Accept: application/json"
         ),
         CURLOPT_RETURNTRANSFER => true,
