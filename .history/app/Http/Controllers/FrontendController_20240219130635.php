...
class FrontendController extends Controller
{
    ...
    public function signup(){
        ...
        $info = ->orderBy('id', 'asc')->get();
        $data =  CourseInfomation::collection($info)->resolve();
        $page= 1;
        $pagdata =  $this->paginate($data, 6, $page); 

        return view('signup', ['toptitle'=>$toptitle,  'currencysymbol'=>$currencysymbol, 'currencyex'=>$currencyex,]);
    }
    ...
    public function contact(Additional $add){
        ...
        return view('newdesign.contact', compact('countries', 'additional', 'currencysymbol', 'toptitle', 'userinfoma'));
    }
