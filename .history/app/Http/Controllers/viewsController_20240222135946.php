...
class viewsController extends Controller
{
    ...
    public function listcoursesfun(CourseInfo $courseInfo, UserCart $usercart){
        ...
        $totalCourses = $info->count();
    $pagdata = 10;
    $currentPage = $pagdata;
    $paginatedData = $info->forPage($currentPage, $pagdata)->values();
        ...
        $currencysymbol =  (new Help)->getplace();
        $currencyex =  (new Help)->moneyconvert(); 
       return    (new Frontends)->listcourses( $paginatedData, $uni, $currentPage, $currencysymbol, $currencyex,  $additionalpic);
    }
            ...
            if($word == "TMC"){
              $decrypt_id =  $this->decrypt($id);
                ...
                if($singlecourse){
                    ...
                    return (new Frontends)->courseinfo($singlecourse, $videos, $word, $usercourse, $allcourse,  $additional,  $toptitle,  $additionalpic);
                }else{
