                            ...
                            <form onSubmit={submit} className="space-y-6">
                                ...
                                <div className="flex items-center justify-between">
                                    ...
                                    <Link 
                                        ...
                                        className="font-['Inter'] font-normal text-[16px] leading-[32.56px] tracking-[0%] text-[#c0392b] hover:text-white hover:bg-[#BE383F] hover:underline transition duration-200 px-3 py-1 rounded"
                                    >
                                        Forgot Password?
                                    </Link>
                                </div>
