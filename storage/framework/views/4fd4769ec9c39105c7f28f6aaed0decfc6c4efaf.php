...
<script>
   ...
   var app = <?php echo e(Js::from($data??"")); ?>;
    var cookies = <?php echo json_encode($cookies??"", 15, 512) ?>;
   var picture = "<?php echo e(asset('image/TMC-Institute-Logo2 1 (1).png')); ?>";
   var mainimg = "<?php echo e(asset('image/Image.png')); ?>";
   var videoimg = "<?php echo e(asset('image/Video call.png')); ?>";
   var audio = "<?php echo e(asset('image/Vector.png')); ?>";
   var live = "<?php echo e(asset('image/Vector (1).png')); ?>";
   var records = "<?php echo e(asset('image/Vector (2).png')); ?>";
   var groups = "<?php echo e(asset('image/Group.png')); ?>";
   var image = "<?php echo e(asset('image/Images.png')); ?>";
   var rectangle = "<?php echo e(asset('image/Rectangle 2870.png')); ?>"
   var rectangle2 = "<?php echo e(asset('image/Rectangle 2870 (1).png')); ?>"
   var rectangle3 = "<?php echo e(asset('image/Rectangle 2870 (2).png')); ?>"
   var rectangle4 = "<?php echo e(asset('image/Rectangle 2870 (3).png')); ?>"
   var userpic = <?php echo e(Js::from(auth()->user()->picture??"")); ?>;
    var username = <?php echo json_encode(session()->get('userdetail')->fullname??"", 15, 512) ?>;
    var image4 = "<?php echo e(asset('image/Image (3).png')); ?>";
    var img2 = "<?php echo e(asset('image/Img (3).png')); ?>"
    var img3 = "<?php echo e(asset('image/Image (6).png')); ?>"
     var hype =    "<?php echo e(Request::url()); ?>";
     var fetchdata = <?php echo json_encode($nibble??"", 15, 512) ?>;
       var usersemail = <?php echo e(Js::from(auth()->user()->email??"")); ?>

       var purchasecourse =<?php echo json_encode($coursepurshase??"", 15, 512) ?>;
       var coursesdata = <?php echo json_encode($coursesdata??"", 15, 512) ?>;
       var cart = <?php echo e(Js::from(json_decode($cart->usercartdetails??''))); ?>;
        ...
        var videos = <?php echo e(Js::from($videos??'')); ?>;
         var coursedetail = <?php echo json_encode($coursedetail??"", 15, 512) ?>;
...
<?php /**PATH /Users/ultraputers/Desktop/React_projeact/TMC_INTITUTE_REACT/resources/views/layout/landing.blade.php ENDPATH**/ ?>